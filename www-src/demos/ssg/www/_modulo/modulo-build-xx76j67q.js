...
window.moduloBuild.modules["x1bjbo4c"] = function ContactFormExample (modulo) {

        const def = modulo.definitions['ContactFormExample'];
        class x_ContactFormExample extends window.HTMLElement {
            constructor() {
                super();
        ...
        modulo.registry.utils.initClass(modulo, def, x_ContactFormExample);
        window.customElements.define(def.TagName, x_ContactFormExample);
        return x_ContactFormExample;
    
};
window.moduloBuild.modules["x17bj73m"] = function ContactFormExample_template (modulo) {
return function (CTX, G) { var OUT=[];
  ...
  OUT.push(":</strong>\n                    </label>\n                    "); // ":</strong></label>"
  if (CTX.field === "text") { // "if field == \"text\""
  OUT.push("\n                        <textarea [state.bind]=\"\" name=\""); // "<textarea [state.bind]=\"\" name=\""
  OUT.push(G.escapeText(CTX.field)); // "field"
  OUT.push("\" for=\""); // "\" for=\""
  OUT.push(G.escapeText(CTX.field)); // "field"
  OUT.push("_"); // "_"
  ...
  OUT.push("\n                        <input [state.bind]=\"\" type=\""); // "<input [state.bind]=\"\" type=\""
...
window.moduloBuild.modules["x116jas3"] = function Page_script (modulo) {
...
window.moduloBuild.modules["x1ih2hl5"] = function Page_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("<head>\n    <title>"); // "<head><title>"
  OUT.push(G.escapeText(CTX.props.title)); // "props.title"
  OUT.push("</title>\n    <meta charset=\"utf8\" />\n\n    <!--\n        Since this Component is \"vanish-into-document\", it's allowed to include\n        loose LINK and SCRIPT tags, which will be interpreted and built,\n        allowing you to more easily integrate existing HTML files here. E.g.:\n    -->\n    <link rel=\"stylesheet\" href=\"/static/css/site.css\" />\n</head>\n<body>\n    <div class=\"Page-container\">\n        <nav class=\"Page-nav\">\n            <img src=\"/static/images/example_logo.svg\" />\n            <ul>\n                "); // "</title><meta charset=\"utf8\" /><!-- Since this Component is \"vanish-into-document\", it's allowed to include loose LINK and SCRIPT tags, which will be interpreted and built, allowing you to more easily integrate existing HTML files here. E.g.: --><link rel=\"stylesheet\" href=\"/static/css/site.css\" /></head><body><div class=\"Page-container\"><nav class=\"Page-nav\"><img src=\"/static/images/example_logo.svg\" /><ul>"
  ...
  OUT.push("\n            </ul>\n        </nav>\n\n        <main class=\"Page-mainContent\">\n            <slot></slot>\n        </main>\n    </div>\n\n    <footer class=\"Page-footer\">\n        &copy; "); // "</ul></nav><main class=\"Page-mainContent\"><slot></slot></main></div><footer class=\"Page-footer\"> &copy;"
...
window.moduloBuild.nameToHash = {
 "Page": "x1d31lu7",
 "ContactFormExample": "x1bjbo4c",
 "Page_script": "x116jas3",
 "Page_template": "x1ih2hl5",
 "ContactFormExample_template": "x17bj73m"
};
window.moduloBuild.definitions = {
 ...
 "ContactFormExample": {
  ...
  "Type": "Component",
  "namespace": "x",
  "name": "ContactFormExample",
  "DefName": null,
  "Parent": null,
  "Name": "ContactFormExample",
  "DefinitionName": "ContactFormExample",
  "ChildrenNames": [
   "ContactFormExample_template",
   "ContactFormExample_state",
   "ContactFormExample_style"
  ],
  "TagName": "x-contactformexample"
 },
 "Page_props": {
  "Type": "Props",
  "title": "",
 ...
 "ContactFormExample_template": {
  ...
  "DefName": null,
  "Parent": "ContactFormExample",
  "Name": "template",
  "DefinitionName": "ContactFormExample_template",
  "Hash": "Tx17bj73m"
 },
 "ContactFormExample_state": {
  "Type": "State",
  ...
  "Parent": "ContactFormExample",
  "Name": "state",
  "DefinitionName": "ContactFormExample_state"
 },
 "ContactFormExample_style": {
  "Type": "Style",
  "DefFinalizers": [
  ...
  "Parent": "ContactFormExample",
  "Name": "style",
  "DefinitionName": "ContactFormExample_style"
 }
};
