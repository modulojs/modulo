...
window.moduloBuild.modules["xxepa8pn"] = function eg_JSON_staticdata (modulo) {
return {"message":"API rate limit exceeded for 23.93.67.213. (But here's the good news: Authenticated requests get a higher rate limit. Check out the documentation for more details.)","documentation_url":"https://docs.github.com/rest/overview/resources-in-the-rest-api#rate-limiting"};
};
window.moduloBuild.nameToHash.eg_JSON_staticdata = "xxepa8pn";
...
eg_JSON_staticdata: {"Parent":"eg_JSON","DefName":null,"Type":"StaticData","DefLoaders":["DefinedAs","DataType","Src"],"DefBuilders":["ContentCSV","ContentTXT","ContentJSON","ContentJS"],"DefFinalizers":["Code","RequireData"],"Content":"{\"message\":\"API rate limit exceeded for 23.93.67.213. (But here's the good news: Authenticated requests get a higher rate limit. Check out the documentation for more details.)\",\"documentation_url\":\"https://docs.github.com/rest/overview/resources-in-the-rest-api#rate-limiting\"}\n","Name":"staticdata","DefinitionName":"eg_JSON_staticdata","Source":"https://api.github.com/repos/modulojs/modulo","data":{"message":"API rate limit exceeded for 23.93.67.213. (But here's the good news: Authenticated requests get a higher rate limit. Check out the documentation for more details.)","documentation_url":"https://docs.github.com/rest/overview/resources-in-the-rest-api#rate-limiting"}}, 
