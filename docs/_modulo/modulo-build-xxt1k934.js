...
window.moduloBuild.modules["xx5s00j0"] = function x_DemoModal (modulo) {
...
window.moduloBuild.nameToHash.x_DemoModal = "xx5s00j0";

window.moduloBuild.modules["xx2v9f9h"] = function x_DemoChart (modulo) {
...
window.moduloBuild.nameToHash.x_DemoChart = "xx2v9f9h";

window.moduloBuild.modules["x14eom9e"] = function x_ExampleBtn (modulo) {
...
window.moduloBuild.nameToHash.x_ExampleBtn = "x14eom9e";

window.moduloBuild.modules["xxpfisou"] = function x_DemoSelector (modulo) {
...
window.moduloBuild.nameToHash.x_DemoSelector = "xxpfisou";
...
window.moduloBuild.modules["x1s25tsu"] = function mws_Page (modulo) {
...
window.moduloBuild.nameToHash.mws_Page = "x1s25tsu";

window.moduloBuild.modules["x13rtp4e"] = function mws_ProjectInfo (modulo) {
...
window.moduloBuild.nameToHash.mws_ProjectInfo = "x13rtp4e";

window.moduloBuild.modules["xx3h55q5"] = function mws_DevLogNav (modulo) {
...
window.moduloBuild.nameToHash.mws_DevLogNav = "xx3h55q5";

window.moduloBuild.modules["xxvftfid"] = function mws_DocSidebar (modulo) {
...
window.moduloBuild.nameToHash.mws_DocSidebar = "xxvftfid";

window.moduloBuild.modules["x1u1aibi"] = function mws_Demo (modulo) {
...
window.moduloBuild.nameToHash.mws_Demo = "x1u1aibi";

window.moduloBuild.modules["x1119ilf"] = function mws_AllExamples (modulo) {
...
window.moduloBuild.nameToHash.mws_AllExamples = "x1119ilf";

window.moduloBuild.modules["xxn7akqc"] = function mws_Section (modulo) {
...
window.moduloBuild.nameToHash.mws_Section = "xxn7akqc";
...
window.moduloBuild.modules["xxxnta78"] = function docseg_Templating_1 (modulo) {
...
window.moduloBuild.nameToHash.docseg_Templating_1 = "xxxnta78";

window.moduloBuild.modules["xx91i2h3"] = function docseg_Templating_PrepareCallback (modulo) {
...
window.moduloBuild.nameToHash.docseg_Templating_PrepareCallback = "xx91i2h3";

window.moduloBuild.modules["x1kdsu7j"] = function docseg_Templating_Comments (modulo) {
...
window.moduloBuild.nameToHash.docseg_Templating_Comments = "x1kdsu7j";

window.moduloBuild.modules["xxr0cfpt"] = function docseg_Templating_Escaping (modulo) {
...
window.moduloBuild.nameToHash.docseg_Templating_Escaping = "xxr0cfpt";

window.moduloBuild.modules["xx37lhrp"] = function docseg_Tutorial_P1 (modulo) {
...
window.moduloBuild.nameToHash.docseg_Tutorial_P1 = "xx37lhrp";

window.moduloBuild.modules["xx8d2or6"] = function docseg_Tutorial_P2 (modulo) {
...
window.moduloBuild.nameToHash.docseg_Tutorial_P2 = "xx8d2or6";

window.moduloBuild.modules["xxl4gufu"] = function docseg_Tutorial_P2_filters_demo (modulo) {
...
window.moduloBuild.nameToHash.docseg_Tutorial_P2_filters_demo = "xxl4gufu";

window.moduloBuild.modules["xx252d0l"] = function docseg_Tutorial_P3_state_demo (modulo) {
...
window.moduloBuild.nameToHash.docseg_Tutorial_P3_state_demo = "xx252d0l";

window.moduloBuild.modules["x1aetug5"] = function docseg_Tutorial_P3_state_bind (modulo) {
...
window.moduloBuild.nameToHash.docseg_Tutorial_P3_state_bind = "x1aetug5";
...
window.moduloBuild.modules["x158ms5i"] = function eg_Hello (modulo) {
...
window.moduloBuild.nameToHash.eg_Hello = "x158ms5i";

window.moduloBuild.modules["xxibvfic"] = function eg_Simple (modulo) {
...
window.moduloBuild.nameToHash.eg_Simple = "xxibvfic";

window.moduloBuild.modules["xxxcj6q0"] = function eg_ToDo (modulo) {
...
window.moduloBuild.nameToHash.eg_ToDo = "xxxcj6q0";

window.moduloBuild.modules["xx6m5rsu"] = function eg_JSON (modulo) {
...
window.moduloBuild.nameToHash.eg_JSON = "xx6m5rsu";

window.moduloBuild.modules["xxla28qd"] = function eg_JSONArray (modulo) {
...
window.moduloBuild.nameToHash.eg_JSONArray = "xxla28qd";

window.moduloBuild.modules["x168ionj"] = function eg_GitHubAPI (modulo) {
...
window.moduloBuild.nameToHash.eg_GitHubAPI = "x168ionj";

window.moduloBuild.modules["x15jou12"] = function eg_ColorSelector (modulo) {
...
window.moduloBuild.nameToHash.eg_ColorSelector = "x15jou12";

window.moduloBuild.modules["xxtoptg1"] = function eg_DateNumberPicker (modulo) {
...
window.moduloBuild.nameToHash.eg_DateNumberPicker = "xxtoptg1";

window.moduloBuild.modules["x1dctbrp"] = function eg_PrimeSieve (modulo) {
...
window.moduloBuild.nameToHash.eg_PrimeSieve = "x1dctbrp";

window.moduloBuild.modules["xx4ggck6"] = function eg_Scatter (modulo) {
...
window.moduloBuild.nameToHash.eg_Scatter = "xx4ggck6";

window.moduloBuild.modules["x1p4v739"] = function eg_FlexibleForm (modulo) {
...
window.moduloBuild.nameToHash.eg_FlexibleForm = "x1p4v739";

window.moduloBuild.modules["x1inkt31"] = function eg_FlexibleFormWithAPI (modulo) {
...
window.moduloBuild.nameToHash.eg_FlexibleFormWithAPI = "x1inkt31";

window.moduloBuild.modules["xxiuqn2g"] = function eg_Components (modulo) {
...
window.moduloBuild.nameToHash.eg_Components = "xxiuqn2g";

window.moduloBuild.modules["x13cim7t"] = function eg_OscillatingGraph (modulo) {
...
window.moduloBuild.nameToHash.eg_OscillatingGraph = "x13cim7t";

window.moduloBuild.modules["x1ora2ru"] = function eg_Search (modulo) {
...
window.moduloBuild.nameToHash.eg_Search = "x1ora2ru";

window.moduloBuild.modules["x18638v1"] = function eg_SearchBox (modulo) {
...
window.moduloBuild.nameToHash.eg_SearchBox = "x18638v1";

window.moduloBuild.modules["x1sohkq4"] = function eg_WorldMap (modulo) {
...
window.moduloBuild.nameToHash.eg_WorldMap = "x1sohkq4";

window.moduloBuild.modules["x1lkl0e5"] = function eg_Memory (modulo) {
...
window.moduloBuild.nameToHash.eg_Memory = "x1lkl0e5";

window.moduloBuild.modules["x13jru7c"] = function eg_ConwayGameOfLife (modulo) {
...
window.moduloBuild.nameToHash.eg_ConwayGameOfLife = "x13jru7c";
...
modulo.register('util', function mountElement (modulo, def, elem) {
    ...
    for (const def of allNames.map(name => modulo.definitions[name])) {
        elem.cparts[def.RenderObj || def.Name] = elem.modulo.instance(def, { element: elem });
    }
    // Mount the element, optionally "merging" in the modulo-original-html attr
    const htmlOriginal = elem.getAttribute('modulo-original-html');
    const original = ((!htmlOriginal || htmlOriginal === '') ? elem :
    ...
    if (elem.hasAttribute('modulo-original-html')) { // Need to mount directives
        const { reconciler } = elem.cparts.component;
        reconciler.patch = reconciler.applyPatch; // Apply patches immediately
        reconciler.patchAndDescendants(elem, 'Mount'); // Trigger every "Mount"
