...
x_DemoModal_template: {"Parent":"x_DemoModal","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"opTokens":"==,>,<,>=,<=,!=,not in,is not,is,in,not,gt,lt","opAliases":{"==":"X === Y","is":"X === Y","gt":"X > Y","lt":"X < Y","is not":"X !== Y","not":"!(Y)","in":"(Y).includes ? (Y).includes(X) : (X in Y)","not in":"!((Y).includes ? (Y).includes(X) : (X in Y))"},"modeTokens":["{% %}","{{ }}","{# #}"],"modes":{},"filters":{},"tags":{},"Name":"template","DefinitionName":"x_DemoModal_template"}, 
...
mws_Page_template: {"Parent":"mws_Page","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"opTokens":"==,>,<,>=,<=,!=,not in,is not,is,in,not,gt,lt","opAliases":{"==":"X === Y","is":"X === Y","gt":"X > Y","lt":"X < Y","is not":"X !== Y","not":"!(Y)","in":"(Y).includes ? (Y).includes(X) : (X in Y)","not in":"!((Y).includes ? (Y).includes(X) : (X in Y))"},"modeTokens":["{% %}","{{ }}","{# #}"],"modes":{},"filters":{},"tags":{},"Name":"template","DefinitionName":"mws_Page_template","Source":"http://127.0.0.1:6627/libraries/mws/Page.html"}, 
...
mws_DevLogNav_template: {"Parent":"mws_DevLogNav","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"opTokens":"==,>,<,>=,<=,!=,not in,is not,is,in,not,gt,lt","opAliases":{"==":"X === Y","is":"X === Y","gt":"X > Y","lt":"X < Y","is not":"X !== Y","not":"!(Y)","in":"(Y).includes ? (Y).includes(X) : (X in Y)","not in":"!((Y).includes ? (Y).includes(X) : (X in Y))"},"modeTokens":["{% %}","{{ }}","{# #}"],"modes":{},"filters":{},"tags":{},"Name":"template","DefinitionName":"mws_DevLogNav_template","Source":"http://127.0.0.1:6627/libraries/mws/DevLogNav.html"}, 
...
mws_DocSidebar_template: {"Parent":"mws_DocSidebar","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"opTokens":"==,>,<,>=,<=,!=,not in,is not,is,in,not,gt,lt","opAliases":{"==":"X === Y","is":"X === Y","gt":"X > Y","lt":"X < Y","is not":"X !== Y","not":"!(Y)","in":"(Y).includes ? (Y).includes(X) : (X in Y)","not in":"!((Y).includes ? (Y).includes(X) : (X in Y))"},"modeTokens":["{% %}","{{ }}","{# #}"],"modes":{},"filters":{},"tags":{},"Name":"template","DefinitionName":"mws_DocSidebar_template","Source":"http://127.0.0.1:6627/libraries/mws/DocSidebar.html"}, 
...
mws_Demo_template: {"Parent":"mws_Demo","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"opTokens":"==,>,<,>=,<=,!=,not in,is not,is,in,not,gt,lt","opAliases":{"==":"X === Y","is":"X === Y","gt":"X > Y","lt":"X < Y","is not":"X !== Y","not":"!(Y)","in":"(Y).includes ? (Y).includes(X) : (X in Y)","not in":"!((Y).includes ? (Y).includes(X) : (X in Y))"},"modeTokens":["{% %}","{{ }}","{# #}"],"modes":{},"filters":{},"tags":{},"Name":"template","DefinitionName":"mws_Demo_template","Source":"http://127.0.0.1:6627/libraries/mws/Demo.html"}, 
...
eg_Memory_template: {"Parent":"eg_Memory","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"opTokens":"==,>,<,>=,<=,!=,not in,is not,is,in,not,gt,lt","opAliases":{"==":"X === Y","is":"X === Y","gt":"X > Y","lt":"X < Y","is not":"X !== Y","not":"!(Y)","in":"(Y).includes ? (Y).includes(X) : (X in Y)","not in":"!((Y).includes ? (Y).includes(X) : (X in Y))"},"modeTokens":["{% %}","{{ }}","{# #}"],"modes":{},"filters":{},"tags":{},"Name":"template","DefinitionName":"eg_Memory_template"}, 
