...
window.moduloBuild.modules["x1u19i4q"] = function modulo_configuration (modulo) {
...
window.moduloBuild.modules["xx6ljctc"] = function modulo_docseg_Templating_1 (modulo) {

let conf;
conf = modulo.definitions['modulo_docseg_Templating_1'];
if (!conf) {
    console.log('ERROR: Empty modulo_docseg_Templating_1 conf:', conf, Object.keys(modulo.definitions));
}
...
const cpartClasses = { Template, State, Script };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Templating_1_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xxg1ev96';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_docseg_Templating_1'];
    }
}

const initRenderObj = { elementClass: _Templating_1_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Templating_1_);
return _Templating_1_;
    
};
window.moduloBuild.modules["x126fsnr"] = function modulo_docseg_Templating_1_script (modulo) {
...
window.moduloBuild.modules["x1nrhiqd"] = function modulo_docseg_Templating_1_template (modulo) {
...
window.moduloBuild.modules["x1gd7o24"] = function modulo_docseg_Templating_Comments (modulo) {

let conf;
conf = modulo.definitions['modulo_docseg_Templating_Comments'];
if (!conf) {
    console.log('ERROR: Empty modulo_docseg_Templating_Comments conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Templating_Comments_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xxl7svrm';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_docseg_Templating_Comments'];
    }
}

const initRenderObj = { elementClass: _Templating_Comments_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Templating_Comments_);
return _Templating_Comments_;
    
};
window.moduloBuild.modules["x1p85et1"] = function modulo_docseg_Templating_Comments_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n    <h1>hello "); // "<h1>hello"
  OUT.push("</h1>\n    "); // "</h1>"
  /* // "comment"
...
window.moduloBuild.modules["x10keog9"] = function modulo_docseg_Templating_Escaping (modulo) {

let conf;
conf = modulo.definitions['modulo_docseg_Templating_Escaping'];
if (!conf) {
    console.log('ERROR: Empty modulo_docseg_Templating_Escaping conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Templating_Escaping_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        ...
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_docseg_Templating_Escaping'];
    }
}

const initRenderObj = { elementClass: _Templating_Escaping_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Templating_Escaping_);
return _Templating_Escaping_;
    
};
window.moduloBuild.modules["x184ue3a"] = function modulo_docseg_Templating_Escaping_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n<p>User \"<em>"); // "<p>User \"<em>"
...
window.moduloBuild.modules["xxfrc7l4"] = function modulo_docseg_Templating_PrepareCallback (modulo) {

let conf;
conf = modulo.definitions['modulo_docseg_Templating_PrepareCallback'];
if (!conf) {
    console.log('ERROR: Empty modulo_docseg_Templating_PrepareCallback conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State, Script, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Templating_PrepareCallback_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        ...
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_docseg_Templating_PrepareCallback'];
    }
}

const initRenderObj = { elementClass: _Templating_PrepareCallback_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Templating_PrepareCallback_);
return _Templating_PrepareCallback_;
    
};
window.moduloBuild.modules["x15c5clt"] = function modulo_docseg_Templating_PrepareCallback_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["xx7jgg2i"] = function modulo_docseg_Templating_PrepareCallback_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["x12v36i6"] = function modulo_docseg_Tutorial_P1 (modulo) {

let conf;
conf = modulo.definitions['modulo_docseg_Tutorial_P1'];
if (!conf) {
    console.log('ERROR: Empty modulo_docseg_Tutorial_P1 conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Tutorial_P1_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xx51qst3';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_docseg_Tutorial_P1'];
    }
}

const initRenderObj = { elementClass: _Tutorial_P1_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Tutorial_P1_);
return _Tutorial_P1_;
    
};
window.moduloBuild.modules["xxm6soph"] = function modulo_docseg_Tutorial_P1_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\nHello <strong>Modulo</strong> World!\n<p class=\"neat\">Any HTML can be here!</p>\n"); // "Hello <strong>Modulo</strong> World! <p class=\"neat\">Any HTML can be here!</p>"

return OUT.join(""); };
};
window.moduloBuild.modules["x1tuka8v"] = function modulo_docseg_Tutorial_P2 (modulo) {

let conf;
conf = modulo.definitions['modulo_docseg_Tutorial_P2'];
if (!conf) {
    console.log('ERROR: Empty modulo_docseg_Tutorial_P2 conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Tutorial_P2_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'x1uj7p64';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_docseg_Tutorial_P2'];
    }
}

const initRenderObj = { elementClass: _Tutorial_P2_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Tutorial_P2_);
return _Tutorial_P2_;
    
};
window.moduloBuild.modules["xxghkdo7"] = function modulo_docseg_Tutorial_P2_filters_demo (modulo) {

let conf;
conf = modulo.definitions['modulo_docseg_Tutorial_P2_filters_demo'];
if (!conf) {
    console.log('ERROR: Empty modulo_docseg_Tutorial_P2_filters_demo conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Tutorial_P2_filters_demo_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xxt0upt6';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_docseg_Tutorial_P2_filters_demo'];
    }
}

const initRenderObj = { elementClass: _Tutorial_P2_filters_demo_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Tutorial_P2_filters_demo_);
return _Tutorial_P2_filters_demo_;
    
};
window.moduloBuild.modules["x1h93c2j"] = function modulo_docseg_Tutorial_P2_filters_demo_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["x1o05fj9"] = function modulo_docseg_Tutorial_P3_state_bind (modulo) {

let conf;
conf = modulo.definitions['modulo_docseg_Tutorial_P3_state_bind'];
if (!conf) {
    console.log('ERROR: Empty modulo_docseg_Tutorial_P3_state_bind conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Tutorial_P3_state_bind_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xxngpccm';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_docseg_Tutorial_P3_state_bind'];
    }
}

const initRenderObj = { elementClass: _Tutorial_P3_state_bind_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Tutorial_P3_state_bind_);
return _Tutorial_P3_state_bind_;
    
};
window.moduloBuild.modules["xxonth4n"] = function modulo_docseg_Tutorial_P3_state_bind_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["xxdkg1k0"] = function modulo_docseg_Tutorial_P3_state_demo (modulo) {

let conf;
conf = modulo.definitions['modulo_docseg_Tutorial_P3_state_demo'];
if (!conf) {
    console.log('ERROR: Empty modulo_docseg_Tutorial_P3_state_demo conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Tutorial_P3_state_demo_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'x1oig15e';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_docseg_Tutorial_P3_state_demo'];
    }
}

const initRenderObj = { elementClass: _Tutorial_P3_state_demo_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Tutorial_P3_state_demo_);
return _Tutorial_P3_state_demo_;
    
};
window.moduloBuild.modules["x13o8260"] = function modulo_docseg_Tutorial_P3_state_demo_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["xx4jdde0"] = function modulo_eg_ColorSelector (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_ColorSelector'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_ColorSelector conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _ColorSelector_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xx6riop6';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_ColorSelector'];
    }
}

const initRenderObj = { elementClass: _ColorSelector_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _ColorSelector_);
return _ColorSelector_;
    
};
window.moduloBuild.modules["x145sdaa"] = function modulo_eg_ColorSelector_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["xxe6a1rb"] = function modulo_eg_Components (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_Components'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_Components conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Components_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xxeg9s6i';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_Components'];
    }
}

const initRenderObj = { elementClass: _Components_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Components_);
return _Components_;
    
};
window.moduloBuild.modules["x1gk8lc3"] = function modulo_eg_Components_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["x1hnddg0"] = function modulo_eg_ConwayGameOfLife (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_ConwayGameOfLife'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_ConwayGameOfLife conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State, Script, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _ConwayGameOfLife_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        ...
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_ConwayGameOfLife'];
    }
}

const initRenderObj = { elementClass: _ConwayGameOfLife_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _ConwayGameOfLife_);
return _ConwayGameOfLife_;
    
};
window.moduloBuild.modules["x18eprt5"] = function modulo_eg_ConwayGameOfLife_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["x1spom4d"] = function modulo_eg_ConwayGameOfLife_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n  <div class=\"grid\">\n    "); // "<div class=\"grid\">"
...
window.moduloBuild.modules["xxvo9fgd"] = function modulo_eg_DateNumberPicker (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_DateNumberPicker'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_DateNumberPicker conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State, Script, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _DateNumberPicker_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'x1i6hhtf';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_DateNumberPicker'];
    }
}

const initRenderObj = { elementClass: _DateNumberPicker_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _DateNumberPicker_);
return _DateNumberPicker_;
    
};
window.moduloBuild.modules["x1ok21rv"] = function modulo_eg_DateNumberPicker_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["x1j17irn"] = function modulo_eg_DateNumberPicker_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n    <p>ISO: <tt>"); // "<p>ISO: <tt>"
...
window.moduloBuild.modules["x1jel26n"] = function modulo_eg_FlexibleForm (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_FlexibleForm'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_FlexibleForm conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _FlexibleForm_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xx4vivet';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_FlexibleForm'];
    }
}

const initRenderObj = { elementClass: _FlexibleForm_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _FlexibleForm_);
return _FlexibleForm_;
    
};
window.moduloBuild.modules["xx57cjdv"] = function modulo_eg_FlexibleFormWithAPI (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_FlexibleFormWithAPI'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_FlexibleFormWithAPI conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State, Script };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _FlexibleFormWithAPI_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        ...
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_FlexibleFormWithAPI'];
    }
}

const initRenderObj = { elementClass: _FlexibleFormWithAPI_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _FlexibleFormWithAPI_);
return _FlexibleFormWithAPI_;
    
};
window.moduloBuild.modules["xxjqdj02"] = function modulo_eg_FlexibleFormWithAPI_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["xxd9oom7"] = function modulo_eg_FlexibleFormWithAPI_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n    <form>\n        "); // "<form>"
...
window.moduloBuild.modules["xxb7eeji"] = function modulo_eg_FlexibleForm_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n    <form>\n        "); // "<form>"
  var ARR0=CTX.state.fields;for (var KEY in ARR0) {CTX. field=ARR0[KEY]; // "for field in state.fields"
  OUT.push("\n            <div class=\"field-pair\">\n                <label for=\""); // "<div class=\"field-pair\"><label for=\""
...
window.moduloBuild.modules["x1b1m19o"] = function modulo_eg_GitHubAPI (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_GitHubAPI'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_GitHubAPI conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State, Script };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _GitHubAPI_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        ...
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_GitHubAPI'];
    }
}

const initRenderObj = { elementClass: _GitHubAPI_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _GitHubAPI_);
return _GitHubAPI_;
    
};
window.moduloBuild.modules["xxhnhhvm"] = function modulo_eg_GitHubAPI_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["x130qf1i"] = function modulo_eg_GitHubAPI_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n<p>"); // "<p>"
...
window.moduloBuild.modules["xxa46mmk"] = function modulo_eg_Hello (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_Hello'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_Hello conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State, Script };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Hello_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'x1icoagp';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_Hello'];
    }
}

const initRenderObj = { elementClass: _Hello_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Hello_);
return _Hello_;
    
};
window.moduloBuild.modules["xxj7crnk"] = function modulo_eg_Hello_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["xx9ntrq4"] = function modulo_eg_Hello_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["x17c6b37"] = function modulo_eg_JSON (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_JSON'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_JSON conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, StaticData };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _JSON_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xxpribqq';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_JSON'];
    }
}

const initRenderObj = { elementClass: _JSON_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _JSON_);
return _JSON_;
    
};
window.moduloBuild.modules["x142k04p"] = function modulo_eg_JSONArray (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_JSONArray'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_JSONArray conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, StaticData };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _JSONArray_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xxcql4f2';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_JSONArray'];
    }
}

const initRenderObj = { elementClass: _JSONArray_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _JSONArray_);
return _JSONArray_;
    
};
window.moduloBuild.modules["xxh7u05q"] = function modulo_eg_JSONArray_staticdata (modulo) {
return [
  {
    "userId": 1,
    "id": 1,
...
window.moduloBuild.modules["x1npfhrn"] = function modulo_eg_JSONArray_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n  "); // ""
...
window.moduloBuild.modules["xx97p37h"] = function modulo_eg_JSON_staticdata (modulo) {
return {
  "id": 542682907,
  ...
  "pushed_at": "2022-10-09T20:11:11Z",
...
window.moduloBuild.modules["x1lhd4rn"] = function modulo_eg_JSON_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["xxpkv28k"] = function modulo_eg_Memory (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_Memory'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_Memory conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State, Script, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Memory_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'x14schu5';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_Memory'];
    }
}

const initRenderObj = { elementClass: _Memory_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Memory_);
return _Memory_;
    
};
window.moduloBuild.modules["x102h7jl"] = function modulo_eg_Memory_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["x1rfau7j"] = function modulo_eg_Memory_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n"); // ""
...
window.moduloBuild.modules["xx9fj7hp"] = function modulo_eg_OscillatingGraph (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_OscillatingGraph'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_OscillatingGraph conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State, Script, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _OscillatingGraph_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xxugu6po';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_OscillatingGraph'];
    }
}

const initRenderObj = { elementClass: _OscillatingGraph_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _OscillatingGraph_);
return _OscillatingGraph_;
    
};
window.moduloBuild.modules["x103uolt"] = function modulo_eg_OscillatingGraph_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["xxqlg44u"] = function modulo_eg_OscillatingGraph_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["xx9419bd"] = function modulo_eg_PrimeSieve (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_PrimeSieve'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_PrimeSieve conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State, Script, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _PrimeSieve_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'x1b9a0ql';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_PrimeSieve'];
    }
}

const initRenderObj = { elementClass: _PrimeSieve_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _PrimeSieve_);
return _PrimeSieve_;
    
};
window.moduloBuild.modules["x130099a"] = function modulo_eg_PrimeSieve_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["xxn6m9dp"] = function modulo_eg_PrimeSieve_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n  <div class=\"grid\">\n    "); // "<div class=\"grid\">"
  var ARR0=CTX.script.exports.range;for (var KEY in ARR0) {CTX. i=ARR0[KEY]; // "for i in script.exports.range"
...
window.moduloBuild.modules["x17tpn1r"] = function modulo_eg_Scatter (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_Scatter'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_Scatter conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, StaticData, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Scatter_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'x137bsev';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_Scatter'];
    }
}

const initRenderObj = { elementClass: _Scatter_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Scatter_);
return _Scatter_;
    
};
window.moduloBuild.modules["xxi72lf8"] = function modulo_eg_Scatter_staticdata (modulo) {
return [
  {
    "id": 1,
    "name": "Leanne Graham",
...
window.moduloBuild.modules["x1ejsk79"] = function modulo_eg_Scatter_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n    "); // ""
...
window.moduloBuild.modules["x175c4q5"] = function modulo_eg_Search (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_Search'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_Search conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State, Script };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Search_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'x10mu0ht';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_Search'];
    }
}

const initRenderObj = { elementClass: _Search_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Search_);
return _Search_;
    
};
window.moduloBuild.modules["x1kie72v"] = function modulo_eg_SearchBox (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_SearchBox'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_SearchBox conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State, StaticData, Script, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _SearchBox_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xxljc2i4';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_SearchBox'];
    }
}

const initRenderObj = { elementClass: _SearchBox_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _SearchBox_);
return _SearchBox_;
    
};
window.moduloBuild.modules["x1saopm6"] = function modulo_eg_SearchBox_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["xxkc3g8k"] = function modulo_eg_SearchBox_staticdata (modulo) {
return {
...
window.moduloBuild.modules["x1k5cj37"] = function modulo_eg_SearchBox_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["x126gnvs"] = function modulo_eg_Search_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["x1l103gn"] = function modulo_eg_Search_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["xxuf72k6"] = function modulo_eg_Simple (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_Simple'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_Simple conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Simple_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xxlo7cf3';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_Simple'];
    }
}

const initRenderObj = { elementClass: _Simple_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Simple_);
return _Simple_;
    
};
window.moduloBuild.modules["xxl4an33"] = function modulo_eg_Simple_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["xxhn5u5g"] = function modulo_eg_ToDo (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_ToDo'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_ToDo conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State, Script };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _ToDo_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'x1k33iqb';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_ToDo'];
    }
}

const initRenderObj = { elementClass: _ToDo_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _ToDo_);
return _ToDo_;
    
};
window.moduloBuild.modules["x118d1eu"] = function modulo_eg_ToDo_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["xxbdh5fm"] = function modulo_eg_ToDo_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n<ol>\n    "); // "<ol>"
...
window.moduloBuild.modules["xx9lnv30"] = function modulo_eg_WorldMap (modulo) {

let conf;
conf = modulo.definitions['modulo_eg_WorldMap'];
if (!conf) {
    console.log('ERROR: Empty modulo_eg_WorldMap conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, StaticData, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _WorldMap_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xxn1lri6';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_eg_WorldMap'];
    }
}

const initRenderObj = { elementClass: _WorldMap_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _WorldMap_);
return _WorldMap_;
    
};
window.moduloBuild.modules["xxmbc1sp"] = function modulo_eg_WorldMap_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n    "); // ""
  var ARR0=CTX.staticdata;for (var KEY in ARR0) {CTX. user=ARR0[KEY]; // "for user in staticdata"
...
window.moduloBuild.modules["xxdqgtjp"] = function modulo_mws_AllExamples (modulo) {

let conf;
conf = modulo.definitions['modulo_mws_AllExamples'];
if (!conf) {
    console.log('ERROR: Empty modulo_mws_AllExamples conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Template, State, Script, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _AllExamples_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xx3m56c2';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_mws_AllExamples'];
    }
}

const initRenderObj = { elementClass: _AllExamples_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _AllExamples_);
return _AllExamples_;
    
};
window.moduloBuild.modules["x1jrrsq9"] = function modulo_mws_AllExamples_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["xxslhngg"] = function modulo_mws_AllExamples_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["xxmlgl96"] = function modulo_mws_Demo (modulo) {

let conf;
conf = modulo.definitions['modulo_mws_Demo'];
if (!conf) {
    console.log('ERROR: Empty modulo_mws_Demo conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Props, Template, State, Script, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Demo_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        ...
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_mws_Demo'];
    }
}

const initRenderObj = { elementClass: _Demo_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Demo_);
return _Demo_;
    
};
window.moduloBuild.modules["x1koqdv2"] = function modulo_mws_Demo_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["xxs8mvob"] = function modulo_mws_Demo_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["xxv9ef7u"] = function modulo_mws_DevLogNav (modulo) {

let conf;
conf = modulo.definitions['modulo_mws_DevLogNav'];
if (!conf) {
    console.log('ERROR: Empty modulo_mws_DevLogNav conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Props, Template, State, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _DevLogNav_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'x1vdla5b';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_mws_DevLogNav'];
    }
}

const initRenderObj = { elementClass: _DevLogNav_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _DevLogNav_);
return _DevLogNav_;
    
};
window.moduloBuild.modules["xxivj2tr"] = function modulo_mws_DevLogNav_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["xxer0f9k"] = function modulo_mws_DocSidebar (modulo) {

let conf;
conf = modulo.definitions['modulo_mws_DocSidebar'];
if (!conf) {
    console.log('ERROR: Empty modulo_mws_DocSidebar conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Props, Template, State, Script, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _DocSidebar_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'x15strma';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_mws_DocSidebar'];
    }
}

const initRenderObj = { elementClass: _DocSidebar_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _DocSidebar_);
return _DocSidebar_;
    
};
window.moduloBuild.modules["x18l04ep"] = function modulo_mws_DocSidebar_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
function initializedCallback() {
...
window.moduloBuild.modules["x1s9cikh"] = function modulo_mws_DocSidebar_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("<ul>\n    "); // "<ul>"
...
window.moduloBuild.modules["x1kbnnc3"] = function modulo_mws_Page (modulo) {

let conf;
conf = modulo.definitions['modulo_mws_Page'];
if (!conf) {
    console.log('ERROR: Empty modulo_mws_Page conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Props, Style, Template, Script };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Page_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        ...
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_mws_Page'];
    }
}

const initRenderObj = { elementClass: _Page_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Page_);
return _Page_;
    
};
window.moduloBuild.modules["xx8bpcen"] = function modulo_mws_Page_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["xx7fpnr6"] = function modulo_mws_Page_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["x12djbq5"] = function modulo_mws_ProjectInfo (modulo) {

let conf;
conf = modulo.definitions['modulo_mws_ProjectInfo'];
if (!conf) {
    console.log('ERROR: Empty modulo_mws_ProjectInfo conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Props, StaticData, Template };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _ProjectInfo_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'x14p1s0v';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_mws_ProjectInfo'];
    }
}

const initRenderObj = { elementClass: _ProjectInfo_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _ProjectInfo_);
return _ProjectInfo_;
    
};
window.moduloBuild.modules["x16qgpjg"] = function modulo_mws_ProjectInfo_staticdata (modulo) {
return {
  "name": "mdu.js",
  "author": "michaelb",
  "version": "0.0.17",
...
window.moduloBuild.modules["xx9t56li"] = function modulo_mws_ProjectInfo_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n        "); // ""
...
window.moduloBuild.modules["xxo1h3gc"] = function modulo_mws_Section (modulo) {

let conf;
conf = modulo.definitions['modulo_mws_Section'];
if (!conf) {
    console.log('ERROR: Empty modulo_mws_Section conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Props, Template, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _Section_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        ...
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_mws_Section'];
    }
}

const initRenderObj = { elementClass: _Section_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _Section_);
return _Section_;
    
};
window.moduloBuild.modules["xx3sjna4"] = function modulo_mws_Section_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["xx27h1gn"] = function modulo_x_DemoChart (modulo) {

let conf;
conf = modulo.definitions['modulo_x_DemoChart'];
if (!conf) {
    console.log('ERROR: Empty modulo_x_DemoChart conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Props, Template, Script, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _DemoChart_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        ...
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_x_DemoChart'];
    }
}

const initRenderObj = { elementClass: _DemoChart_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _DemoChart_);
return _DemoChart_;
    
};
window.moduloBuild.modules["xxeaisui"] = function modulo_x_DemoChart_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["xx9i16tt"] = function modulo_x_DemoChart_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["x10nr9j8"] = function modulo_x_DemoModal (modulo) {

let conf;
conf = modulo.definitions['modulo_x_DemoModal'];
if (!conf) {
    console.log('ERROR: Empty modulo_x_DemoModal conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Props, Template, State, Script, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _DemoModal_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'x1rpq1pk';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_x_DemoModal'];
    }
}

const initRenderObj = { elementClass: _DemoModal_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _DemoModal_);
return _DemoModal_;
    
};
window.moduloBuild.modules["xxqruikr"] = function modulo_x_DemoModal_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["xx2noapr"] = function modulo_x_DemoModal_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["xxv7kqed"] = function modulo_x_DemoSelector (modulo) {

let conf;
conf = modulo.definitions['modulo_x_DemoSelector'];
if (!conf) {
    console.log('ERROR: Empty modulo_x_DemoSelector conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Props, Template, State, Script, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _DemoSelector_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xxripjvb';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_x_DemoSelector'];
    }
}

const initRenderObj = { elementClass: _DemoSelector_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _DemoSelector_);
return _DemoSelector_;
    
};
window.moduloBuild.modules["x101oqv4"] = function modulo_x_DemoSelector_script (modulo) {
var script = { exports: {} }; var component, modulo, library, props, style, template, staticdata, configuration, script, state, element, cparts;function __set(name, value) { if (name === 'component') component = value; if (name === 'modulo') modulo = value; if (name === 'library') library = value; if (name === 'props') props = value; if (name === 'style') style = value; if (name === 'template') template = value; if (name === 'staticdata') staticdata = value; if (name === 'configuration') configuration = value; if (name === 'script') script = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
window.moduloBuild.modules["xxbjtni2"] = function modulo_x_DemoSelector_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n        "); // ""
...
window.moduloBuild.modules["xx8iau34"] = function modulo_x_ExampleBtn (modulo) {

let conf;
conf = modulo.definitions['modulo_x_ExampleBtn'];
if (!conf) {
    console.log('ERROR: Empty modulo_x_ExampleBtn conf:', conf, Object.keys(modulo.definitions));
}
if (typeof tagName === 'undefined') { var tagName = conf.TagName; } // HAX XXX
...
const cpartClasses = { Props, Template, Style };
const factoryPatches = modulo.getLifecyclePatches(cpartClasses, [ 'factory' ], confArray);
class _ExampleBtn_ extends modulo.registry.utils.BaseElement {
    constructor() {
        super();
        this.modulo = modulo;
        this.defHash = 'xxi2kvpp';
        this.initRenderObj = initRenderObj;
        this.moduloChildrenData = confArray;
        this.moduloComponentConf = modulo.definitions['modulo_x_ExampleBtn'];
    }
}

const initRenderObj = { elementClass: _ExampleBtn_ };
modulo.applyPatches(factoryPatches, initRenderObj);
window.customElements.define(tagName, _ExampleBtn_);
return _ExampleBtn_;
    
};
window.moduloBuild.modules["xx5ann6n"] = function modulo_x_ExampleBtn_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.nameToHash = {
 "modulo_x_DemoModal": "x10nr9j8",
 "modulo_x_DemoChart": "xx27h1gn",
 "modulo_x_ExampleBtn": "xx8iau34",
 "modulo_x_DemoSelector": "xxv7kqed",
 "modulo_mws_Page": "x1kbnnc3",
 "modulo_mws_ProjectInfo": "x12djbq5",
 "modulo_mws_DevLogNav": "xxv9ef7u",
 "modulo_mws_DocSidebar": "xxer0f9k",
 "modulo_mws_Demo": "xxmlgl96",
 "modulo_mws_AllExamples": "xxdqgtjp",
 "modulo_mws_Section": "xxo1h3gc",
 "modulo_docseg_Templating_1": "xx6ljctc",
 "modulo_docseg_Templating_PrepareCallback": "xxfrc7l4",
 "modulo_docseg_Templating_Comments": "x1gd7o24",
 "modulo_docseg_Templating_Escaping": "x10keog9",
 "modulo_docseg_Tutorial_P1": "x12v36i6",
 "modulo_docseg_Tutorial_P2": "x1tuka8v",
 "modulo_docseg_Tutorial_P2_filters_demo": "xxghkdo7",
 "modulo_docseg_Tutorial_P3_state_demo": "xxdkg1k0",
 "modulo_docseg_Tutorial_P3_state_bind": "x1o05fj9",
 "modulo_eg_Hello": "xxa46mmk",
 "modulo_eg_Simple": "xxuf72k6",
 "modulo_eg_ToDo": "xxhn5u5g",
 "modulo_eg_JSON": "x17c6b37",
 "modulo_eg_JSONArray": "x142k04p",
 "modulo_eg_GitHubAPI": "x1b1m19o",
 "modulo_eg_ColorSelector": "xx4jdde0",
 "modulo_eg_DateNumberPicker": "xxvo9fgd",
 "modulo_eg_PrimeSieve": "xx9419bd",
 "modulo_eg_Scatter": "x17tpn1r",
 "modulo_eg_FlexibleForm": "x1jel26n",
 "modulo_eg_FlexibleFormWithAPI": "xx57cjdv",
 "modulo_eg_Components": "xxe6a1rb",
 "modulo_eg_OscillatingGraph": "xx9fj7hp",
 "modulo_eg_Search": "x175c4q5",
 "modulo_eg_SearchBox": "x1kie72v",
 "modulo_eg_WorldMap": "xx9lnv30",
 "modulo_eg_Memory": "xxpkv28k",
 "modulo_eg_ConwayGameOfLife": "x1hnddg0",
 "modulo_configuration": "x1u19i4q",
 "modulo_x_DemoModal_template": "xx2noapr",
 "modulo_x_DemoChart_template": "xx9i16tt",
 "modulo_x_ExampleBtn_template": "xx5ann6n",
 "modulo_x_DemoSelector_template": "xxbjtni2",
 "modulo_mws_Page_template": "xx7fpnr6",
 "modulo_mws_ProjectInfo_template": "xx9t56li",
 "modulo_mws_DevLogNav_template": "xxivj2tr",
 "modulo_mws_DocSidebar_template": "x1s9cikh",
 "modulo_mws_Demo_template": "xxs8mvob",
 "modulo_mws_AllExamples_template": "xxslhngg",
 "modulo_mws_Section_template": "xx3sjna4",
 "modulo_docseg_Templating_1_template": "x1nrhiqd",
 "modulo_docseg_Templating_PrepareCallback_template": "xx7jgg2i",
 "modulo_docseg_Templating_Comments_template": "x1p85et1",
 "modulo_docseg_Templating_Escaping_template": "x184ue3a",
 "modulo_docseg_Tutorial_P1_template": "xxm6soph",
 "modulo_docseg_Tutorial_P2_template": "x1h93c2j",
 "modulo_docseg_Tutorial_P2_filters_demo_template": "x1h93c2j",
 "modulo_docseg_Tutorial_P3_state_demo_template": "x13o8260",
 "modulo_docseg_Tutorial_P3_state_bind_template": "xxonth4n",
 "modulo_eg_Hello_template": "xx9ntrq4",
 "modulo_eg_Simple_template": "xxl4an33",
 "modulo_eg_ToDo_template": "xxbdh5fm",
 "modulo_eg_JSON_template": "x1lhd4rn",
 "modulo_eg_JSONArray_template": "x1npfhrn",
 "modulo_eg_GitHubAPI_template": "x130qf1i",
 "modulo_eg_ColorSelector_template": "x145sdaa",
 "modulo_eg_DateNumberPicker_template": "x1j17irn",
 "modulo_eg_PrimeSieve_template": "xxn6m9dp",
 "modulo_eg_Scatter_template": "x1ejsk79",
 "modulo_eg_FlexibleForm_template": "xxb7eeji",
 "modulo_eg_FlexibleFormWithAPI_template": "xxd9oom7",
 "modulo_eg_Components_template": "x1gk8lc3",
 "modulo_eg_OscillatingGraph_template": "xxqlg44u",
 "modulo_eg_Search_template": "x1l103gn",
 "modulo_eg_SearchBox_template": "x1k5cj37",
 "modulo_eg_WorldMap_template": "xxmbc1sp",
 "modulo_eg_Memory_template": "x1rfau7j",
 "modulo_eg_ConwayGameOfLife_template": "x1spom4d",
 "modulo_x_DemoModal_script": "xxqruikr",
 "modulo_x_DemoChart_script": "xxeaisui",
 "modulo_x_DemoSelector_script": "x101oqv4",
 "modulo_mws_Page_script": "xx8bpcen",
 "modulo_mws_DocSidebar_script": "x18l04ep",
 "modulo_mws_Demo_script": "x1koqdv2",
 "modulo_mws_AllExamples_script": "x1jrrsq9",
 "modulo_docseg_Templating_1_script": "x126fsnr",
 "modulo_docseg_Templating_PrepareCallback_script": "x15c5clt",
 "modulo_eg_Hello_script": "xxj7crnk",
 "modulo_eg_ToDo_script": "x118d1eu",
 "modulo_eg_GitHubAPI_script": "xxhnhhvm",
 "modulo_eg_DateNumberPicker_script": "x1ok21rv",
 "modulo_eg_PrimeSieve_script": "x130099a",
 "modulo_eg_FlexibleFormWithAPI_script": "xxjqdj02",
 "modulo_eg_OscillatingGraph_script": "x103uolt",
 "modulo_eg_Search_script": "x126gnvs",
 "modulo_eg_SearchBox_script": "x1saopm6",
 "modulo_eg_Memory_script": "x102h7jl",
 "modulo_eg_ConwayGameOfLife_script": "x18eprt5",
 "modulo_mws_ProjectInfo_staticdata": "x16qgpjg",
 "modulo_eg_JSON_staticdata": "xx97p37h",
 "modulo_eg_JSONArray_staticdata": "xxh7u05q",
 "modulo_eg_Scatter_staticdata": "xxi72lf8",
 "modulo_eg_SearchBox_staticdata": "xxkc3g8k",
 "modulo_eg_WorldMap_staticdata": "xxi72lf8"
};
window.moduloBuild.definitions = {
 "modulo": {
  ...
  "Parent": null,
  "Name": "modulo",
  "DefinitionName": "modulo",
  "Hash": "xxcghavi",
  "ChildrenNames": [
   "modulo_configuration",
   "modulo_x",
   "modulo_mws",
   "modulo_docseg",
   "modulo_eg"
 ...
 "modulo_configuration": {
  ...
  "Parent": "modulo",
  "Name": "configuration",
  "DefinitionName": "modulo_configuration",
  "cachedComponentDefs": {
   "/libraries/eg.html": {
 ...
 "modulo_x": {
  ...
  "DefName": "x",
  "Parent": "modulo",
  "DefinitionName": "modulo_x",
  "Hash": "xxulc6v5",
  "ChildrenNames": [
   "modulo_x_DemoModal",
   "modulo_x_DemoChart",
   "modulo_x_ExampleBtn",
   "modulo_x_DemoSelector"
  ],
  "Prebuild": "modulo_x"
 },
 "modulo_mws": {
  ...
  "DefName": "mws",
  "Parent": "modulo",
  "DefinitionName": "modulo_mws",
  "Hash": "xxm0phcd",
  "ChildrenNames": [
   "modulo_mws_Page",
   "modulo_mws_ProjectInfo",
   "modulo_mws_DevLogNav",
   "modulo_mws_DocSidebar",
   "modulo_mws_Demo",
   "modulo_mws_AllExamples",
   "modulo_mws_Section"
  ],
  "Prebuild": "modulo_mws"
 },
 "modulo_docseg": {
  ...
  "DefName": "docseg",
  "Parent": "modulo",
  "DefinitionName": "modulo_docseg",
  "Hash": "xxs9953o",
  "ChildrenNames": [
   "modulo_docseg_Templating_1",
   "modulo_docseg_Templating_PrepareCallback",
   "modulo_docseg_Templating_Comments",
   "modulo_docseg_Templating_Escaping",
   "modulo_docseg_Tutorial_P1",
   "modulo_docseg_Tutorial_P2",
   "modulo_docseg_Tutorial_P2_filters_demo",
   "modulo_docseg_Tutorial_P3_state_demo",
   "modulo_docseg_Tutorial_P3_state_bind"
  ],
  "Prebuild": "modulo_docseg"
 },
 "modulo_eg": {
  "Type": "Library",
  "ConfPreprocessors": [
  ...
  "ChildrenNames": [
   ...
   "modulo_eg_JSONArray",
   "modulo_eg_GitHubAPI",
   "modulo_eg_ColorSelector",
   "modulo_eg_DateNumberPicker",
   "modulo_eg_PrimeSieve",
   "modulo_eg_Scatter",
   "modulo_eg_FlexibleForm",
   "modulo_eg_FlexibleFormWithAPI",
   "modulo_eg_Components",
   "modulo_eg_OscillatingGraph",
   "modulo_eg_Search",
   "modulo_eg_SearchBox",
   "modulo_eg_WorldMap",
   "modulo_eg_Memory",
   "modulo_eg_ConwayGameOfLife"
  ],
  "Prebuild": "modulo_eg"
 },
 "modulo_x_DemoModal": {
  ...
  "Parent": "modulo_x",
  "Name": "DemoModal",
  "DefinitionName": "modulo_x_DemoModal",
  "ChildrenNames": [
   "modulo_x_DemoModal_props",
   "modulo_x_DemoModal_template",
   "modulo_x_DemoModal_state",
   "modulo_x_DemoModal_script",
   "modulo_x_DemoModal_style"
  ],
  "Hash": "x1rpq1pk",
  "TagName": "x-demomodal",
  "MainRequire": "modulo_x_DemoModal"
 },
 "modulo_x_DemoChart": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_x",
  "Name": "DemoChart",
  "DefinitionName": "modulo_x_DemoChart",
  "ChildrenNames": [
   "modulo_x_DemoChart_props",
   "modulo_x_DemoChart_template",
   "modulo_x_DemoChart_script",
   "modulo_x_DemoChart_style"
  ],
  "Hash": "x1sgecs4",
  "TagName": "x-demochart",
  "MainRequire": "modulo_x_DemoChart"
 },
 "modulo_x_ExampleBtn": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_x",
  "Name": "ExampleBtn",
  "DefinitionName": "modulo_x_ExampleBtn",
  "ChildrenNames": [
   "modulo_x_ExampleBtn_props",
   "modulo_x_ExampleBtn_template",
   "modulo_x_ExampleBtn_style"
  ],
  "Hash": "xxi2kvpp",
  "TagName": "x-examplebtn",
  "MainRequire": "modulo_x_ExampleBtn"
 },
 "modulo_x_DemoSelector": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_x",
  "Name": "DemoSelector",
  "DefinitionName": "modulo_x_DemoSelector",
  "ChildrenNames": [
   "modulo_x_DemoSelector_props",
   "modulo_x_DemoSelector_template",
   "modulo_x_DemoSelector_state",
   "modulo_x_DemoSelector_script",
   "modulo_x_DemoSelector_style"
  ],
  "Hash": "xxripjvb",
  "TagName": "x-demoselector",
  "MainRequire": "modulo_x_DemoSelector"
 },
 "modulo_mws_Page": {
  "Type": "Component",
  ...
  "Parent": "modulo_mws",
  "Name": "Page",
  "DefinitionName": "modulo_mws_Page",
  "ChildrenNames": [
   "modulo_mws_Page_props",
   "modulo_mws_Page_style",
   "modulo_mws_Page_template",
   "modulo_mws_Page_script"
  ],
  "Hash": "x1ekhkl1",
  "TagName": "mws-page",
  "MainRequire": "modulo_mws_Page"
 },
 "modulo_mws_ProjectInfo": {
  "Type": "Component",
  "mode": "vanish",
  ...
  "Parent": "modulo_mws",
  "Name": "ProjectInfo",
  "DefinitionName": "modulo_mws_ProjectInfo",
  "ChildrenNames": [
   "modulo_mws_ProjectInfo_props",
   "modulo_mws_ProjectInfo_staticdata",
   "modulo_mws_ProjectInfo_template"
  ],
  "Hash": "x14p1s0v",
  "TagName": "mws-projectinfo",
  "MainRequire": "modulo_mws_ProjectInfo"
 },
 "modulo_mws_DevLogNav": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_mws",
  "Name": "DevLogNav",
  "DefinitionName": "modulo_mws_DevLogNav",
  "ChildrenNames": [
   "modulo_mws_DevLogNav_props",
   "modulo_mws_DevLogNav_template",
   "modulo_mws_DevLogNav_state",
   "modulo_mws_DevLogNav_style"
  ],
  "Hash": "x1vdla5b",
  "TagName": "mws-devlognav",
  "MainRequire": "modulo_mws_DevLogNav"
 },
 "modulo_mws_DocSidebar": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_mws",
  "Name": "DocSidebar",
  "DefinitionName": "modulo_mws_DocSidebar",
  "ChildrenNames": [
   "modulo_mws_DocSidebar_props",
   "modulo_mws_DocSidebar_template",
   "modulo_mws_DocSidebar_state",
   "modulo_mws_DocSidebar_script",
   "modulo_mws_DocSidebar_style"
  ],
  "Hash": "x15strma",
  "TagName": "mws-docsidebar",
  "MainRequire": "modulo_mws_DocSidebar"
 },
 "modulo_mws_Demo": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_mws",
  "Name": "Demo",
  "DefinitionName": "modulo_mws_Demo",
  "ChildrenNames": [
   "modulo_mws_Demo_props",
   "modulo_mws_Demo_template",
   "modulo_mws_Demo_state",
   "modulo_mws_Demo_script",
   "modulo_mws_Demo_style"
  ],
  "Hash": "x1l0sjo3",
  "TagName": "mws-demo",
  "MainRequire": "modulo_mws_Demo"
 },
 "modulo_mws_AllExamples": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_mws",
  "Name": "AllExamples",
  "DefinitionName": "modulo_mws_AllExamples",
  "ChildrenNames": [
   "modulo_mws_AllExamples_template",
   "modulo_mws_AllExamples_state",
   "modulo_mws_AllExamples_script",
   "modulo_mws_AllExamples_style"
  ],
  "Hash": "xx3m56c2",
  "TagName": "mws-allexamples",
  "MainRequire": "modulo_mws_AllExamples"
 },
 "modulo_mws_Section": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_mws",
  "Name": "Section",
  "DefinitionName": "modulo_mws_Section",
  "ChildrenNames": [
   "modulo_mws_Section_props",
   "modulo_mws_Section_template",
   "modulo_mws_Section_style"
  ],
  "Hash": "x1d1j0ca",
  "TagName": "mws-section",
  "MainRequire": "modulo_mws_Section"
 },
 "modulo_docseg_Templating_1": {
  "Type": "Component",
  "mode": "regular",
  ...
  "name": "Templating_1",
  "DefName": null,
  "Parent": "modulo_docseg",
  "Name": "Templating_1",
  "DefinitionName": "modulo_docseg_Templating_1",
  "ChildrenNames": [
   "modulo_docseg_Templating_1_template",
   "modulo_docseg_Templating_1_state",
   "modulo_docseg_Templating_1_script"
  ],
  "Hash": "xxg1ev96",
  "TagName": "docseg-templating_1",
  "MainRequire": "modulo_docseg_Templating_1"
 },
 "modulo_docseg_Templating_PrepareCallback": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_docseg",
  "Name": "Templating_PrepareCallback",
  "DefinitionName": "modulo_docseg_Templating_PrepareCallback",
  "ChildrenNames": [
   "modulo_docseg_Templating_PrepareCallback_template",
   "modulo_docseg_Templating_PrepareCallback_state",
   "modulo_docseg_Templating_PrepareCallback_script",
   "modulo_docseg_Templating_PrepareCallback_style"
  ],
  "Hash": "x1u7tsfu",
  "TagName": "docseg-templating_preparecallback",
  "MainRequire": "modulo_docseg_Templating_PrepareCallback"
 },
 "modulo_docseg_Templating_Comments": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_docseg",
  "Name": "Templating_Comments",
  "DefinitionName": "modulo_docseg_Templating_Comments",
  "ChildrenNames": [
   "modulo_docseg_Templating_Comments_template"
  ],
  "Hash": "xxl7svrm",
  "TagName": "docseg-templating_comments",
  "MainRequire": "modulo_docseg_Templating_Comments"
 },
 "modulo_docseg_Templating_Escaping": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_docseg",
  "Name": "Templating_Escaping",
  "DefinitionName": "modulo_docseg_Templating_Escaping",
  "ChildrenNames": [
   "modulo_docseg_Templating_Escaping_template",
   "modulo_docseg_Templating_Escaping_state",
   "modulo_docseg_Templating_Escaping_style"
  ],
  "Hash": "x1ehsatd",
  "TagName": "docseg-templating_escaping",
  "MainRequire": "modulo_docseg_Templating_Escaping"
 },
 "modulo_docseg_Tutorial_P1": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_docseg",
  "Name": "Tutorial_P1",
  "DefinitionName": "modulo_docseg_Tutorial_P1",
  "ChildrenNames": [
   "modulo_docseg_Tutorial_P1_template",
   "modulo_docseg_Tutorial_P1_style"
  ],
  "Hash": "xx51qst3",
  "TagName": "docseg-tutorial_p1",
  "MainRequire": "modulo_docseg_Tutorial_P1"
 },
 "modulo_docseg_Tutorial_P2": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_docseg",
  "Name": "Tutorial_P2",
  "DefinitionName": "modulo_docseg_Tutorial_P2",
  "ChildrenNames": [
   "modulo_docseg_Tutorial_P2_template"
  ],
  "Hash": "x1uj7p64",
  "TagName": "docseg-tutorial_p2",
  "MainRequire": "modulo_docseg_Tutorial_P2"
 },
 "modulo_docseg_Tutorial_P2_filters_demo": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_docseg",
  "Name": "Tutorial_P2_filters_demo",
  "DefinitionName": "modulo_docseg_Tutorial_P2_filters_demo",
  "ChildrenNames": [
   "modulo_docseg_Tutorial_P2_filters_demo_template"
  ],
  "Hash": "xxt0upt6",
  "TagName": "docseg-tutorial_p2_filters_demo",
  "MainRequire": "modulo_docseg_Tutorial_P2_filters_demo"
 },
 "modulo_docseg_Tutorial_P3_state_demo": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_docseg",
  "Name": "Tutorial_P3_state_demo",
  "DefinitionName": "modulo_docseg_Tutorial_P3_state_demo",
  "ChildrenNames": [
   "modulo_docseg_Tutorial_P3_state_demo_template",
   "modulo_docseg_Tutorial_P3_state_demo_state",
   "modulo_docseg_Tutorial_P3_state_demo_style"
  ],
  "Hash": "x1oig15e",
  "TagName": "docseg-tutorial_p3_state_demo",
  "MainRequire": "modulo_docseg_Tutorial_P3_state_demo"
 },
 "modulo_docseg_Tutorial_P3_state_bind": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_docseg",
  "Name": "Tutorial_P3_state_bind",
  "DefinitionName": "modulo_docseg_Tutorial_P3_state_bind",
  "ChildrenNames": [
   "modulo_docseg_Tutorial_P3_state_bind_template",
   "modulo_docseg_Tutorial_P3_state_bind_state"
  ],
  "Hash": "xxngpccm",
  "TagName": "docseg-tutorial_p3_state_bind",
  "MainRequire": "modulo_docseg_Tutorial_P3_state_bind"
 },
 "modulo_eg_Hello": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "Hello",
  "DefinitionName": "modulo_eg_Hello",
  "ChildrenNames": [
   "modulo_eg_Hello_template",
   "modulo_eg_Hello_state",
   "modulo_eg_Hello_script"
  ],
  "Hash": "x1icoagp",
  "TagName": "eg-hello",
  "MainRequire": "modulo_eg_Hello"
 },
 "modulo_eg_Simple": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "Simple",
  "DefinitionName": "modulo_eg_Simple",
  "ChildrenNames": [
   "modulo_eg_Simple_template",
   "modulo_eg_Simple_style"
  ],
  "Hash": "xxlo7cf3",
  "TagName": "eg-simple",
  "MainRequire": "modulo_eg_Simple"
 },
 "modulo_eg_ToDo": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "ToDo",
  "DefinitionName": "modulo_eg_ToDo",
  "ChildrenNames": [
   "modulo_eg_ToDo_template",
   "modulo_eg_ToDo_state",
   "modulo_eg_ToDo_script"
  ],
  "Hash": "x1k33iqb",
  "TagName": "eg-todo",
  "MainRequire": "modulo_eg_ToDo"
 },
 "modulo_eg_JSON": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "JSON",
  "DefinitionName": "modulo_eg_JSON",
  "ChildrenNames": [
   "modulo_eg_JSON_template",
   "modulo_eg_JSON_staticdata"
  ],
  "Hash": "xxpribqq",
  "TagName": "eg-json",
  "MainRequire": "modulo_eg_JSON"
 },
 "modulo_eg_JSONArray": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "JSONArray",
  "DefinitionName": "modulo_eg_JSONArray",
  "ChildrenNames": [
   "modulo_eg_JSONArray_template",
   "modulo_eg_JSONArray_staticdata"
  ],
  "Hash": "xxcql4f2",
  "TagName": "eg-jsonarray",
  "MainRequire": "modulo_eg_JSONArray"
 },
 "modulo_eg_GitHubAPI": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "GitHubAPI",
  "DefinitionName": "modulo_eg_GitHubAPI",
  "ChildrenNames": [
   "modulo_eg_GitHubAPI_template",
   "modulo_eg_GitHubAPI_state",
   "modulo_eg_GitHubAPI_script"
  ],
  "Hash": "x1at59fc",
  "TagName": "eg-githubapi",
  "MainRequire": "modulo_eg_GitHubAPI"
 },
 "modulo_eg_ColorSelector": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "ColorSelector",
  "DefinitionName": "modulo_eg_ColorSelector",
  "ChildrenNames": [
   "modulo_eg_ColorSelector_template",
   "modulo_eg_ColorSelector_state"
  ],
  "Hash": "xx6riop6",
  "TagName": "eg-colorselector",
  "MainRequire": "modulo_eg_ColorSelector"
 },
 "modulo_eg_DateNumberPicker": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "DateNumberPicker",
  "DefinitionName": "modulo_eg_DateNumberPicker",
  "ChildrenNames": [
   "modulo_eg_DateNumberPicker_template",
   "modulo_eg_DateNumberPicker_state",
   "modulo_eg_DateNumberPicker_script",
   "modulo_eg_DateNumberPicker_style"
  ],
  "Hash": "x1i6hhtf",
  "TagName": "eg-datenumberpicker",
  "MainRequire": "modulo_eg_DateNumberPicker"
 },
 "modulo_eg_PrimeSieve": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "PrimeSieve",
  "DefinitionName": "modulo_eg_PrimeSieve",
  "ChildrenNames": [
   "modulo_eg_PrimeSieve_template",
   "modulo_eg_PrimeSieve_state",
   "modulo_eg_PrimeSieve_script",
   "modulo_eg_PrimeSieve_style"
  ],
  "Hash": "x1b9a0ql",
  "TagName": "eg-primesieve",
  "MainRequire": "modulo_eg_PrimeSieve"
 },
 "modulo_eg_Scatter": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "Scatter",
  "DefinitionName": "modulo_eg_Scatter",
  "ChildrenNames": [
   "modulo_eg_Scatter_template",
   "modulo_eg_Scatter_staticdata",
   "modulo_eg_Scatter_style"
  ],
  "Hash": "x137bsev",
  "TagName": "eg-scatter",
  "MainRequire": "modulo_eg_Scatter"
 },
 "modulo_eg_FlexibleForm": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "FlexibleForm",
  "DefinitionName": "modulo_eg_FlexibleForm",
  "ChildrenNames": [
   "modulo_eg_FlexibleForm_template",
   "modulo_eg_FlexibleForm_Spartacus"
  ],
  "Hash": "xx4vivet",
  "TagName": "eg-flexibleform",
  "MainRequire": "modulo_eg_FlexibleForm"
 },
 "modulo_eg_FlexibleFormWithAPI": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "FlexibleFormWithAPI",
  "DefinitionName": "modulo_eg_FlexibleFormWithAPI",
  "ChildrenNames": [
   "modulo_eg_FlexibleFormWithAPI_template",
   "modulo_eg_FlexibleFormWithAPI_state",
   "modulo_eg_FlexibleFormWithAPI_script"
  ],
  "Hash": "x1sg84mj",
  "TagName": "eg-flexibleformwithapi",
  "MainRequire": "modulo_eg_FlexibleFormWithAPI"
 },
 "modulo_eg_Components": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "Components",
  "DefinitionName": "modulo_eg_Components",
  "ChildrenNames": [
   "modulo_eg_Components_template"
  ],
  "Hash": "xxeg9s6i",
  "TagName": "eg-components",
  "MainRequire": "modulo_eg_Components"
 },
 "modulo_eg_OscillatingGraph": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "OscillatingGraph",
  "DefinitionName": "modulo_eg_OscillatingGraph",
  "ChildrenNames": [
   "modulo_eg_OscillatingGraph_template",
   "modulo_eg_OscillatingGraph_state",
   "modulo_eg_OscillatingGraph_script",
   "modulo_eg_OscillatingGraph_style"
  ],
  "Hash": "xxugu6po",
  "TagName": "eg-oscillatinggraph",
  "MainRequire": "modulo_eg_OscillatingGraph"
 },
 "modulo_eg_Search": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "Search",
  "DefinitionName": "modulo_eg_Search",
  "ChildrenNames": [
   "modulo_eg_Search_template",
   "modulo_eg_Search_state",
   "modulo_eg_Search_script"
  ],
  "Hash": "x10mu0ht",
  "TagName": "eg-search",
  "MainRequire": "modulo_eg_Search"
 },
 "modulo_eg_SearchBox": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "SearchBox",
  "DefinitionName": "modulo_eg_SearchBox",
  "ChildrenNames": [
   "modulo_eg_SearchBox_template",
   "modulo_eg_SearchBox_state",
   "modulo_eg_SearchBox_staticdata",
   "modulo_eg_SearchBox_script",
   "modulo_eg_SearchBox_style"
  ],
  "Hash": "xxljc2i4",
  "TagName": "eg-searchbox",
  "MainRequire": "modulo_eg_SearchBox"
 },
 "modulo_eg_WorldMap": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "WorldMap",
  "DefinitionName": "modulo_eg_WorldMap",
  "ChildrenNames": [
   "modulo_eg_WorldMap_template",
   "modulo_eg_WorldMap_staticdata",
   "modulo_eg_WorldMap_style"
  ],
  "Hash": "xxn1lri6",
  "TagName": "eg-worldmap",
  "MainRequire": "modulo_eg_WorldMap"
 },
 "modulo_eg_Memory": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "Memory",
  "DefinitionName": "modulo_eg_Memory",
  "ChildrenNames": [
   "modulo_eg_Memory_template",
   "modulo_eg_Memory_state",
   "modulo_eg_Memory_script",
   "modulo_eg_Memory_style"
  ],
  "Hash": "x14schu5",
  "TagName": "eg-memory",
  "MainRequire": "modulo_eg_Memory"
 },
 "modulo_eg_ConwayGameOfLife": {
  "Type": "Component",
  "mode": "regular",
  ...
  "Parent": "modulo_eg",
  "Name": "ConwayGameOfLife",
  "DefinitionName": "modulo_eg_ConwayGameOfLife",
  "ChildrenNames": [
   "modulo_eg_ConwayGameOfLife_template",
   "modulo_eg_ConwayGameOfLife_state",
   "modulo_eg_ConwayGameOfLife_script",
   "modulo_eg_ConwayGameOfLife_style"
  ],
  "Hash": "x1ketdcf",
  "TagName": "eg-conwaygameoflife",
  "MainRequire": "modulo_eg_ConwayGameOfLife"
 },
 "modulo_x_DemoModal_props": {
  "Type": "Props",
  "RenderObj": "props",
  ...
  "Content": "",
  "DefName": null,
  "Parent": "modulo_x_DemoModal",
  "Name": "props",
  "DefinitionName": "modulo_x_DemoModal_props"
 },
 "modulo_x_DemoModal_template": {
  "Type": "Template",
  "RenderObj": "template",
  ...
  "Parent": "modulo_x_DemoModal",
  "Name": "template",
  "DefinitionName": "modulo_x_DemoModal_template",
  "Hash": "Txx2noapr"
 },
 "modulo_x_DemoModal_state": {
  "Type": "State",
  ...
  "Parent": "modulo_x_DemoModal",
  "Name": "state",
  "DefinitionName": "modulo_x_DemoModal_state"
 },
 "modulo_x_DemoModal_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_x_DemoModal",
  "Name": "script",
  "DefinitionName": "modulo_x_DemoModal_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_x_DemoModal_style": {
  ...
  "Parent": "modulo_x_DemoModal",
  "Name": "style",
  "DefinitionName": "modulo_x_DemoModal_style"
 },
 "modulo_x_DemoChart_props": {
  "Type": "Props",
  "RenderObj": "props",
  ...
  "Content": "",
  "DefName": null,
  "Parent": "modulo_x_DemoChart",
  "Name": "props",
  "DefinitionName": "modulo_x_DemoChart_props"
 },
 "modulo_x_DemoChart_template": {
  "Type": "Template",
  "RenderObj": "template",
  ...
  "Parent": "modulo_x_DemoChart",
  "Name": "template",
  "DefinitionName": "modulo_x_DemoChart_template",
  "Hash": "Txx9i16tt"
 },
 "modulo_x_DemoChart_script": {
  "Type": "Script",
  ...
  "Parent": "modulo_x_DemoChart",
  "Name": "script",
  "DefinitionName": "modulo_x_DemoChart_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_x_DemoChart_style": {
  ...
  "Parent": "modulo_x_DemoChart",
  "Name": "style",
  "DefinitionName": "modulo_x_DemoChart_style"
 },
 "modulo_x_ExampleBtn_props": {
  "Type": "Props",
  "RenderObj": "props",
  ...
  "Content": "",
  "DefName": null,
  "Parent": "modulo_x_ExampleBtn",
  "Name": "props",
  "DefinitionName": "modulo_x_ExampleBtn_props"
 },
 "modulo_x_ExampleBtn_template": {
  "Type": "Template",
  "RenderObj": "template",
  ...
  "Parent": "modulo_x_ExampleBtn",
  "Name": "template",
  "DefinitionName": "modulo_x_ExampleBtn_template",
  "Hash": "Txx5ann6n"
 },
 "modulo_x_ExampleBtn_style": {
  "Type": "Style",
  ...
  "Parent": "modulo_x_ExampleBtn",
  "Name": "style",
  "DefinitionName": "modulo_x_ExampleBtn_style"
 },
 "modulo_x_DemoSelector_props": {
  "Type": "Props",
  "RenderObj": "props",
  ...
  "Content": "",
  "DefName": null,
  "Parent": "modulo_x_DemoSelector",
  "Name": "props",
  "DefinitionName": "modulo_x_DemoSelector_props"
 },
 "modulo_x_DemoSelector_template": {
  "Type": "Template",
  "RenderObj": "template",
  ...
  "Parent": "modulo_x_DemoSelector",
  "Name": "template",
  "DefinitionName": "modulo_x_DemoSelector_template",
  "Hash": "Txxbjtni2"
 },
 "modulo_x_DemoSelector_state": {
  "Type": "State",
  ...
  "Parent": "modulo_x_DemoSelector",
  "Name": "state",
  "DefinitionName": "modulo_x_DemoSelector_state"
 },
 "modulo_x_DemoSelector_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_x_DemoSelector",
  "Name": "script",
  "DefinitionName": "modulo_x_DemoSelector_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_x_DemoSelector_style": {
  ...
  "Parent": "modulo_x_DemoSelector",
  "Name": "style",
  "DefinitionName": "modulo_x_DemoSelector_style"
 },
 "modulo_mws_Page_props": {
  "Type": "Props",
  "RenderObj": "props",
  ...
  "Content": "",
  "DefName": null,
  "Parent": "modulo_mws_Page",
  "Name": "props",
  "DefinitionName": "modulo_mws_Page_props"
 },
 "modulo_mws_Page_style": {
  "Type": "Style",
  "RenderObj": "style",
  ...
  "Parent": "modulo_mws_Page",
  "Name": "style",
  "DefinitionName": "modulo_mws_Page_style"
 },
 "modulo_mws_Page_template": {
  "Type": "Template",
  "RenderObj": "template",
  ...
  "Parent": "modulo_mws_Page",
  "Name": "template",
  "DefinitionName": "modulo_mws_Page_template",
  "Hash": "Txx7fpnr6"
 },
 "modulo_mws_Page_script": {
  "Type": "Script",
  ...
  "Parent": "modulo_mws_Page",
  "Name": "script",
  "DefinitionName": "modulo_mws_Page_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_mws_ProjectInfo_props": {
  ...
  "Content": "",
  "DefName": null,
  "Parent": "modulo_mws_ProjectInfo",
  "Name": "props",
  "DefinitionName": "modulo_mws_ProjectInfo_props"
 },
 "modulo_mws_ProjectInfo_staticdata": {
  "Type": "StaticData",
  ...
  "Parent": "modulo_mws_ProjectInfo",
  "Name": "staticdata",
  "DefinitionName": "modulo_mws_ProjectInfo_staticdata",
  "Hash": "x16qgpjg"
 },
 "modulo_mws_ProjectInfo_template": {
  "Type": "Template",
  ...
  "Parent": "modulo_mws_ProjectInfo",
  "Name": "template",
  "DefinitionName": "modulo_mws_ProjectInfo_template",
  "Hash": "Txx9t56li"
 },
 "modulo_mws_DevLogNav_props": {
  "Type": "Props",
  ...
  "Content": "",
  "DefName": null,
  "Parent": "modulo_mws_DevLogNav",
  "Name": "props",
  "DefinitionName": "modulo_mws_DevLogNav_props"
 },
 "modulo_mws_DevLogNav_template": {
  "Type": "Template",
  "RenderObj": "template",
  ...
  "Parent": "modulo_mws_DevLogNav",
  "Name": "template",
  "DefinitionName": "modulo_mws_DevLogNav_template",
  "Hash": "Txxivj2tr"
 },
 "modulo_mws_DevLogNav_state": {
  "Type": "State",
  ...
  "Parent": "modulo_mws_DevLogNav",
  "Name": "state",
  "DefinitionName": "modulo_mws_DevLogNav_state"
 },
 "modulo_mws_DevLogNav_style": {
  "Type": "Style",
  "RenderObj": "style",
  ...
  "Parent": "modulo_mws_DevLogNav",
  "Name": "style",
  "DefinitionName": "modulo_mws_DevLogNav_style"
 },
 "modulo_mws_DocSidebar_props": {
  "Type": "Props",
  "RenderObj": "props",
  ...
  "Content": "",
  "DefName": null,
  "Parent": "modulo_mws_DocSidebar",
  "Name": "props",
  "DefinitionName": "modulo_mws_DocSidebar_props"
 },
 "modulo_mws_DocSidebar_template": {
  "Type": "Template",
  "RenderObj": "template",
  ...
  "Parent": "modulo_mws_DocSidebar",
  "Name": "template",
  "DefinitionName": "modulo_mws_DocSidebar_template",
  "Hash": "Tx1s9cikh"
 },
 "modulo_mws_DocSidebar_state": {
  "Type": "State",
  ...
  "Parent": "modulo_mws_DocSidebar",
  "Name": "state",
  "DefinitionName": "modulo_mws_DocSidebar_state"
 },
 "modulo_mws_DocSidebar_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_mws_DocSidebar",
  "Name": "script",
  "DefinitionName": "modulo_mws_DocSidebar_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_mws_DocSidebar_style": {
  ...
  "Parent": "modulo_mws_DocSidebar",
  "Name": "style",
  "DefinitionName": "modulo_mws_DocSidebar_style"
 },
 "modulo_mws_Demo_props": {
  "Type": "Props",
  "RenderObj": "props",
  ...
  "Content": "",
  "DefName": null,
  "Parent": "modulo_mws_Demo",
  "Name": "props",
  "DefinitionName": "modulo_mws_Demo_props"
 },
 "modulo_mws_Demo_template": {
  "Type": "Template",
  "RenderObj": "template",
  ...
  "Parent": "modulo_mws_Demo",
  "Name": "template",
  "DefinitionName": "modulo_mws_Demo_template",
  "Hash": "Txxs8mvob"
 },
 "modulo_mws_Demo_state": {
  "Type": "State",
  ...
  "Parent": "modulo_mws_Demo",
  "Name": "state",
  "DefinitionName": "modulo_mws_Demo_state"
 },
 "modulo_mws_Demo_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_mws_Demo",
  "Name": "script",
  "DefinitionName": "modulo_mws_Demo_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_mws_Demo_style": {
  ...
  "Parent": "modulo_mws_Demo",
  "Name": "style",
  "DefinitionName": "modulo_mws_Demo_style"
 },
 "modulo_mws_AllExamples_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_mws_AllExamples",
  "Name": "template",
  "DefinitionName": "modulo_mws_AllExamples_template",
  "Hash": "Txxslhngg"
 },
 "modulo_mws_AllExamples_state": {
  "Type": "State",
  ...
  "Parent": "modulo_mws_AllExamples",
  "Name": "state",
  "DefinitionName": "modulo_mws_AllExamples_state"
 },
 "modulo_mws_AllExamples_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_mws_AllExamples",
  "Name": "script",
  "DefinitionName": "modulo_mws_AllExamples_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_mws_AllExamples_style": {
  ...
  "Parent": "modulo_mws_AllExamples",
  "Name": "style",
  "DefinitionName": "modulo_mws_AllExamples_style"
 },
 "modulo_mws_Section_props": {
  "Type": "Props",
  "RenderObj": "props",
  ...
  "Content": "",
  "DefName": null,
  "Parent": "modulo_mws_Section",
  "Name": "props",
  "DefinitionName": "modulo_mws_Section_props"
 },
 "modulo_mws_Section_template": {
  "Type": "Template",
  "RenderObj": "template",
  ...
  "Parent": "modulo_mws_Section",
  "Name": "template",
  "DefinitionName": "modulo_mws_Section_template",
  "Hash": "Txx3sjna4"
 },
 "modulo_mws_Section_style": {
  "Type": "Style",
  ...
  "Parent": "modulo_mws_Section",
  "Name": "style",
  "DefinitionName": "modulo_mws_Section_style"
 },
 "modulo_docseg_Templating_1_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_docseg_Templating_1",
  "Name": "template",
  "DefinitionName": "modulo_docseg_Templating_1_template",
  "Hash": "Tx1nrhiqd"
 },
 "modulo_docseg_Templating_1_state": {
  "Type": "State",
  ...
  "Parent": "modulo_docseg_Templating_1",
  "Name": "state",
  "DefinitionName": "modulo_docseg_Templating_1_state"
 },
 "modulo_docseg_Templating_1_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_docseg_Templating_1",
  "Name": "script",
  "DefinitionName": "modulo_docseg_Templating_1_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_docseg_Templating_PrepareCallback_template": {
  ...
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_docseg_Templating_PrepareCallback",
  "Name": "template",
  "DefinitionName": "modulo_docseg_Templating_PrepareCallback_template",
  "Hash": "Txx7jgg2i"
 },
 "modulo_docseg_Templating_PrepareCallback_state": {
  "Type": "State",
  ...
  "Parent": "modulo_docseg_Templating_PrepareCallback",
  "Name": "state",
  "DefinitionName": "modulo_docseg_Templating_PrepareCallback_state"
 },
 "modulo_docseg_Templating_PrepareCallback_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_docseg_Templating_PrepareCallback",
  "Name": "script",
  "DefinitionName": "modulo_docseg_Templating_PrepareCallback_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_docseg_Templating_PrepareCallback_style": {
  ...
  "Parent": "modulo_docseg_Templating_PrepareCallback",
  "Name": "style",
  "DefinitionName": "modulo_docseg_Templating_PrepareCallback_style"
 },
 "modulo_docseg_Templating_Comments_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_docseg_Templating_Comments",
  "Name": "template",
  "DefinitionName": "modulo_docseg_Templating_Comments_template",
  "Hash": "Tx1p85et1"
 },
 "modulo_docseg_Templating_Escaping_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_docseg_Templating_Escaping",
  "Name": "template",
  "DefinitionName": "modulo_docseg_Templating_Escaping_template",
  "Hash": "Tx184ue3a"
 },
 "modulo_docseg_Templating_Escaping_state": {
  "Type": "State",
  ...
  "Parent": "modulo_docseg_Templating_Escaping",
  "Name": "state",
  "DefinitionName": "modulo_docseg_Templating_Escaping_state"
 },
 "modulo_docseg_Templating_Escaping_style": {
  "Type": "Style",
  "RenderObj": "style",
  ...
  "Parent": "modulo_docseg_Templating_Escaping",
  "Name": "style",
  "DefinitionName": "modulo_docseg_Templating_Escaping_style"
 },
 "modulo_docseg_Tutorial_P1_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_docseg_Tutorial_P1",
  "Name": "template",
  "DefinitionName": "modulo_docseg_Tutorial_P1_template",
  "Hash": "Txxm6soph"
 },
 "modulo_docseg_Tutorial_P1_style": {
  "Type": "Style",
  ...
  "Parent": "modulo_docseg_Tutorial_P1",
  "Name": "style",
  "DefinitionName": "modulo_docseg_Tutorial_P1_style"
 },
 "modulo_docseg_Tutorial_P2_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_docseg_Tutorial_P2",
  "Name": "template",
  "DefinitionName": "modulo_docseg_Tutorial_P2_template",
  "Hash": "Tx1h93c2j"
 },
 "modulo_docseg_Tutorial_P2_filters_demo_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_docseg_Tutorial_P2_filters_demo",
  "Name": "template",
  "DefinitionName": "modulo_docseg_Tutorial_P2_filters_demo_template",
  "Hash": "Tx1h93c2j"
 },
 "modulo_docseg_Tutorial_P3_state_demo_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_docseg_Tutorial_P3_state_demo",
  "Name": "template",
  "DefinitionName": "modulo_docseg_Tutorial_P3_state_demo_template",
  "Hash": "Tx13o8260"
 },
 "modulo_docseg_Tutorial_P3_state_demo_state": {
  "Type": "State",
  ...
  "Parent": "modulo_docseg_Tutorial_P3_state_demo",
  "Name": "state",
  "DefinitionName": "modulo_docseg_Tutorial_P3_state_demo_state"
 },
 "modulo_docseg_Tutorial_P3_state_demo_style": {
  "Type": "Style",
  "RenderObj": "style",
  ...
  "Parent": "modulo_docseg_Tutorial_P3_state_demo",
  "Name": "style",
  "DefinitionName": "modulo_docseg_Tutorial_P3_state_demo_style"
 },
 "modulo_docseg_Tutorial_P3_state_bind_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_docseg_Tutorial_P3_state_bind",
  "Name": "template",
  "DefinitionName": "modulo_docseg_Tutorial_P3_state_bind_template",
  "Hash": "Txxonth4n"
 },
 "modulo_docseg_Tutorial_P3_state_bind_state": {
  "Type": "State",
  ...
  "Parent": "modulo_docseg_Tutorial_P3_state_bind",
  "Name": "state",
  "DefinitionName": "modulo_docseg_Tutorial_P3_state_bind_state"
 },
 "modulo_eg_Hello_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_Hello",
  "Name": "template",
  "DefinitionName": "modulo_eg_Hello_template",
  "Hash": "Txx9ntrq4"
 },
 "modulo_eg_Hello_state": {
  "Type": "State",
  ...
  "Parent": "modulo_eg_Hello",
  "Name": "state",
  "DefinitionName": "modulo_eg_Hello_state"
 },
 "modulo_eg_Hello_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_eg_Hello",
  "Name": "script",
  "DefinitionName": "modulo_eg_Hello_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_eg_Simple_template": {
  ...
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_Simple",
  "Name": "template",
  "DefinitionName": "modulo_eg_Simple_template",
  "Hash": "Txxl4an33"
 },
 "modulo_eg_Simple_style": {
  "Type": "Style",
  ...
  "Parent": "modulo_eg_Simple",
  "Name": "style",
  "DefinitionName": "modulo_eg_Simple_style"
 },
 "modulo_eg_ToDo_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_ToDo",
  "Name": "template",
  "DefinitionName": "modulo_eg_ToDo_template",
  "Hash": "Txxbdh5fm"
 },
 "modulo_eg_ToDo_state": {
  "Type": "State",
  ...
  "Parent": "modulo_eg_ToDo",
  "Name": "state",
  "DefinitionName": "modulo_eg_ToDo_state"
 },
 "modulo_eg_ToDo_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_eg_ToDo",
  "Name": "script",
  "DefinitionName": "modulo_eg_ToDo_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_eg_JSON_template": {
  ...
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_JSON",
  "Name": "template",
  "DefinitionName": "modulo_eg_JSON_template",
  "Hash": "Tx1lhd4rn"
 },
 "modulo_eg_JSON_staticdata": {
  "Type": "StaticData",
  ...
  "Parent": "modulo_eg_JSON",
  "Name": "staticdata",
  "DefinitionName": "modulo_eg_JSON_staticdata",
  "Hash": "xx97p37h"
 },
 "modulo_eg_JSONArray_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_JSONArray",
  "Name": "template",
  "DefinitionName": "modulo_eg_JSONArray_template",
  "Hash": "Tx1npfhrn"
 },
 "modulo_eg_JSONArray_staticdata": {
  "Type": "StaticData",
  ...
  "Parent": "modulo_eg_JSONArray",
  "Name": "staticdata",
  "DefinitionName": "modulo_eg_JSONArray_staticdata",
  "Hash": "xxh7u05q"
 },
 "modulo_eg_GitHubAPI_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_GitHubAPI",
  "Name": "template",
  "DefinitionName": "modulo_eg_GitHubAPI_template",
  "Hash": "Tx130qf1i"
 },
 "modulo_eg_GitHubAPI_state": {
  "Type": "State",
  ...
  "Parent": "modulo_eg_GitHubAPI",
  "Name": "state",
  "DefinitionName": "modulo_eg_GitHubAPI_state"
 },
 "modulo_eg_GitHubAPI_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_eg_GitHubAPI",
  "Name": "script",
  "DefinitionName": "modulo_eg_GitHubAPI_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_eg_ColorSelector_template": {
  ...
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_ColorSelector",
  "Name": "template",
  "DefinitionName": "modulo_eg_ColorSelector_template",
  "Hash": "Tx145sdaa"
 },
 "modulo_eg_ColorSelector_state": {
  "Type": "State",
  ...
  "Parent": "modulo_eg_ColorSelector",
  "Name": "state",
  "DefinitionName": "modulo_eg_ColorSelector_state"
 },
 "modulo_eg_DateNumberPicker_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_DateNumberPicker",
  "Name": "template",
  "DefinitionName": "modulo_eg_DateNumberPicker_template",
  "Hash": "Tx1j17irn"
 },
 "modulo_eg_DateNumberPicker_state": {
  "Type": "State",
  ...
  "Parent": "modulo_eg_DateNumberPicker",
  "Name": "state",
  "DefinitionName": "modulo_eg_DateNumberPicker_state"
 },
 "modulo_eg_DateNumberPicker_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_eg_DateNumberPicker",
  "Name": "script",
  "DefinitionName": "modulo_eg_DateNumberPicker_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_eg_DateNumberPicker_style": {
  ...
  "Parent": "modulo_eg_DateNumberPicker",
  "Name": "style",
  "DefinitionName": "modulo_eg_DateNumberPicker_style"
 },
 "modulo_eg_PrimeSieve_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_PrimeSieve",
  "Name": "template",
  "DefinitionName": "modulo_eg_PrimeSieve_template",
  "Hash": "Txxn6m9dp"
 },
 "modulo_eg_PrimeSieve_state": {
  "Type": "State",
  ...
  "Parent": "modulo_eg_PrimeSieve",
  "Name": "state",
  "DefinitionName": "modulo_eg_PrimeSieve_state"
 },
 "modulo_eg_PrimeSieve_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_eg_PrimeSieve",
  "Name": "script",
  "DefinitionName": "modulo_eg_PrimeSieve_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_eg_PrimeSieve_style": {
  ...
  "Parent": "modulo_eg_PrimeSieve",
  "Name": "style",
  "DefinitionName": "modulo_eg_PrimeSieve_style"
 },
 "modulo_eg_Scatter_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_Scatter",
  "Name": "template",
  "DefinitionName": "modulo_eg_Scatter_template",
  "Hash": "Tx1ejsk79"
 },
 "modulo_eg_Scatter_staticdata": {
  "Type": "StaticData",
  ...
  "Parent": "modulo_eg_Scatter",
  "Name": "staticdata",
  "DefinitionName": "modulo_eg_Scatter_staticdata",
  "Hash": "xxi72lf8"
 },
 "modulo_eg_Scatter_style": {
  "Type": "Style",
  ...
  "Parent": "modulo_eg_Scatter",
  "Name": "style",
  "DefinitionName": "modulo_eg_Scatter_style"
 },
 "modulo_eg_FlexibleForm_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_FlexibleForm",
  "Name": "template",
  "DefinitionName": "modulo_eg_FlexibleForm_template",
  "Hash": "Txxb7eeji"
 },
 "modulo_eg_FlexibleForm_Spartacus": {
  "Type": "State",
  ...
  "Parent": "modulo_eg_FlexibleForm",
  "Name": "Spartacus",
  "DefinitionName": "modulo_eg_FlexibleForm_Spartacus"
 },
 "modulo_eg_FlexibleFormWithAPI_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_FlexibleFormWithAPI",
  "Name": "template",
  "DefinitionName": "modulo_eg_FlexibleFormWithAPI_template",
  "Hash": "Txxd9oom7"
 },
 "modulo_eg_FlexibleFormWithAPI_state": {
  "Type": "State",
  ...
  "Parent": "modulo_eg_FlexibleFormWithAPI",
  "Name": "state",
  "DefinitionName": "modulo_eg_FlexibleFormWithAPI_state"
 },
 "modulo_eg_FlexibleFormWithAPI_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_eg_FlexibleFormWithAPI",
  "Name": "script",
  "DefinitionName": "modulo_eg_FlexibleFormWithAPI_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_eg_Components_template": {
  ...
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_Components",
  "Name": "template",
  "DefinitionName": "modulo_eg_Components_template",
  "Hash": "Tx1gk8lc3"
 },
 "modulo_eg_OscillatingGraph_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_OscillatingGraph",
  "Name": "template",
  "DefinitionName": "modulo_eg_OscillatingGraph_template",
  "Hash": "Txxqlg44u"
 },
 "modulo_eg_OscillatingGraph_state": {
  "Type": "State",
  ...
  "Parent": "modulo_eg_OscillatingGraph",
  "Name": "state",
  "DefinitionName": "modulo_eg_OscillatingGraph_state"
 },
 "modulo_eg_OscillatingGraph_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_eg_OscillatingGraph",
  "Name": "script",
  "DefinitionName": "modulo_eg_OscillatingGraph_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_eg_OscillatingGraph_style": {
  ...
  "Parent": "modulo_eg_OscillatingGraph",
  "Name": "style",
  "DefinitionName": "modulo_eg_OscillatingGraph_style"
 },
 "modulo_eg_Search_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_Search",
  "Name": "template",
  "DefinitionName": "modulo_eg_Search_template",
  "Hash": "Tx1l103gn"
 },
 "modulo_eg_Search_state": {
  "Type": "State",
  ...
  "Parent": "modulo_eg_Search",
  "Name": "state",
  "DefinitionName": "modulo_eg_Search_state"
 },
 "modulo_eg_Search_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_eg_Search",
  "Name": "script",
  "DefinitionName": "modulo_eg_Search_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_eg_SearchBox_template": {
  ...
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_SearchBox",
  "Name": "template",
  "DefinitionName": "modulo_eg_SearchBox_template",
  "Hash": "Tx1k5cj37"
 },
 "modulo_eg_SearchBox_state": {
  "Type": "State",
  ...
  "Parent": "modulo_eg_SearchBox",
  "Name": "state",
  "DefinitionName": "modulo_eg_SearchBox_state"
 },
 "modulo_eg_SearchBox_staticdata": {
  "Type": "StaticData",
  "RenderObj": "staticdata",
  ...
  "Parent": "modulo_eg_SearchBox",
  "Name": "staticdata",
  "DefinitionName": "modulo_eg_SearchBox_staticdata",
  "Hash": "xxkc3g8k"
 },
 "modulo_eg_SearchBox_script": {
  "Type": "Script",
  ...
  "Parent": "modulo_eg_SearchBox",
  "Name": "script",
  "DefinitionName": "modulo_eg_SearchBox_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_eg_SearchBox_style": {
  ...
  "Parent": "modulo_eg_SearchBox",
  "Name": "style",
  "DefinitionName": "modulo_eg_SearchBox_style"
 },
 "modulo_eg_WorldMap_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_WorldMap",
  "Name": "template",
  "DefinitionName": "modulo_eg_WorldMap_template",
  "Hash": "Txxmbc1sp"
 },
 "modulo_eg_WorldMap_staticdata": {
  "Type": "StaticData",
  ...
  "Parent": "modulo_eg_WorldMap",
  "Name": "staticdata",
  "DefinitionName": "modulo_eg_WorldMap_staticdata",
  "Hash": "xxi72lf8"
 },
 "modulo_eg_WorldMap_style": {
  "Type": "Style",
  ...
  "Parent": "modulo_eg_WorldMap",
  "Name": "style",
  "DefinitionName": "modulo_eg_WorldMap_style"
 },
 "modulo_eg_Memory_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_Memory",
  "Name": "template",
  "DefinitionName": "modulo_eg_Memory_template",
  "Hash": "Tx1rfau7j"
 },
 "modulo_eg_Memory_state": {
  "Type": "State",
  ...
  "Parent": "modulo_eg_Memory",
  "Name": "state",
  "DefinitionName": "modulo_eg_Memory_state"
 },
 "modulo_eg_Memory_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_eg_Memory",
  "Name": "script",
  "DefinitionName": "modulo_eg_Memory_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_eg_Memory_style": {
  ...
  "Parent": "modulo_eg_Memory",
  "Name": "style",
  "DefinitionName": "modulo_eg_Memory_style"
 },
 "modulo_eg_ConwayGameOfLife_template": {
  "Type": "Template",
  "RenderObj": "template",
  "DefName": null,
  "Parent": "modulo_eg_ConwayGameOfLife",
  "Name": "template",
  "DefinitionName": "modulo_eg_ConwayGameOfLife_template",
  "Hash": "Tx1spom4d"
 },
 "modulo_eg_ConwayGameOfLife_state": {
  "Type": "State",
  ...
  "Parent": "modulo_eg_ConwayGameOfLife",
  "Name": "state",
  "DefinitionName": "modulo_eg_ConwayGameOfLife_state"
 },
 "modulo_eg_ConwayGameOfLife_script": {
  "Type": "Script",
  "RenderObj": "script",
  ...
  "Parent": "modulo_eg_ConwayGameOfLife",
  "Name": "script",
  "DefinitionName": "modulo_eg_ConwayGameOfLife_script",
  "localVars": [
   "component",
   "modulo",
   "library",
 ...
 "modulo_eg_ConwayGameOfLife_style": {
  ...
  "Parent": "modulo_eg_ConwayGameOfLife",
  "Name": "style",
  "DefinitionName": "modulo_eg_ConwayGameOfLife_style"
 }
};
