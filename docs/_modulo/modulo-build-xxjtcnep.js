...
window.moduloBuild.modules["x1s93asd"] = function Pagee (modulo) {

            const def = modulo.definitions['Pagee'];
            class mws_Pagee extends window.HTMLElement {
                constructor() { super(); this.init(); }
                connectedCallback() { window.setTimeout(() => this.parsedCallback(), 0); }
            }
            modulo.registry.utils.initComponentClass(modulo, def, mws_Pagee);
            window.customElements.define(def.TagName, mws_Pagee);
            return mws_Pagee;
        
};
window.moduloBuild.nameToHash.Pagee = "x1s93asd";

window.moduloBuild.modules["x1skf4rq"] = function Pagee_template (modulo) {
...
window.moduloBuild.nameToHash.Pagee_template = "x1skf4rq";

window.moduloBuild.definitions = { 
modulo: {"Parent":null,"DefName":null,"Type":"Modulo","ChildPrefix":"","Contains":"coreDefs","DefLoaders":["DefTarget","DefinedAs","Src","Content"],"defaultDef":{"DefTarget":null,"DefinedAs":null,"DefName":null},"defaultDefLoaders":["DefTarget","DefinedAs","Src"],"src":"/js/Modulo.js","Name":"modulo","DefinitionName":"modulo","ChildrenNames":["Pagee"]}, 

Pagee: {"Parent":"modulo","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefTarget","DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"mws","name":"Pagee","Name":"Pagee","DefinitionName":"Pagee","ChildrenNames":["Pagee_template","Pagee_state","Pagee_style"],"TagName":"mws-pagee"}, 

Pagee_template: {"Parent":"Pagee","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"Pagee_template","Hash":"Tx1skf4rq"}, 

Pagee_state: {"Parent":"Pagee","DefName":null,"Content":"","Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"test":"okay","Name":"state","DefinitionName":"Pagee_state"}, 

Pagee_style: {"Parent":"Pagee","DefName":null,"Type":"Style","DefFinalizers":["Content|PrefixCSS"],"Name":"style","DefinitionName":"Pagee_style"}, 
