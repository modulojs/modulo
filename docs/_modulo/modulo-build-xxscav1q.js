...
window.moduloBuild.modules["xxp91sn8"] = function mws_DocSidebar_script (modulo) {
...
window.moduloBuild.nameToHash.mws_DocSidebar_script = "xxp91sn8";
...
modulo: {"Parent":null,"DefName":null,"Type":"Modulo","ChildPrefix":"","Contains":"coreDefs","DefLoaders":["DefTarget","DefinedAs","Src","Content"],"defaultDef":{"DefTarget":null,"DefinedAs":null,"DefName":null},"src":"/js/Modulo.js","Name":"modulo","DefinitionName":"modulo","Source":"http://127.0.0.1:6627/libraries/all.html","ChildrenNames":["configuration","x","mws","docseg","eg"]}, 

configuration: {"Parent":"modulo","DefName":null,"Type":"Configuration","DefBuilders":["Content|Code","DefinitionName|MainRequire"],"Name":"configuration","Source":"http://127.0.0.1:6627/js/codemirror_5.63.0/codemirror_bundled.js"}, 
...
mws_DevLogNav_template: {"Parent":"mws_DevLogNav","DefName":null,"Content":"<nav style=\"{% if props.fn %}border-bottom: none{% endif %}\">\n    <h4>DEV LOG</h4>\n\n    <ul>\n        {% for pair in state.nav %}\n            <li>\n                {% if pair|get:0 == props.fn %}\n                    <span style=\"text-decoration: overline underline;\">\n                        {{ pair|get:0 }}&nbsp;({{ pair|get:1 }})\n                    </span>\n                {% else %}\n                    <a href=\"/devlog/{{ pair|get:0 }}.html\">\n                        {{ pair|get:0 }}&nbsp;({{ pair|get:1 }})\n                    </a>\n                {% endif %}\n            </li>\n        {% endfor %}\n    </ul>\n</nav>\n\n{% for pair in state.nav %}\n    {% if pair|get:0 == props.fn %}\n        <h1>{{ pair|get:1 }}</h1>\n    {% endif %}\n{% endfor %}\n\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"mws_DevLogNav_template","Source":"http://127.0.0.1:6627/libraries/mws/DevLogNav.html"}, 
...
mws_DevLogNav_style: {"Parent":"mws_DevLogNav","DefName":null,"Content":"nav {\n    min-height: 100px;\n    padding: 20px;\n    clear: both;\n    display: block;\n    max-width: 700px;\n    margin: 10px auto 0 auto;\n    display: flex;\n    border: 1px dotted #888;\n}\n\nul {\n    display: grid;\n    grid-auto-flow: column;\n    grid-template-columns: 1fr 1fr 1fr;\n    grid-template-rows: 1fr 1fr;\n}\n\nh4 {\n    font-weight: bold;\n    border-right: 1px dotted #888;\n    color: #888;\n    margin-right: 10px;\n}\n\nh1 {\n    font-weight: bold;\n    text-align: center;\n    border: 1px dotted #888;\n    margin-top: -1px;\n    padding: 10px;\n    margin-bottom: 20px;\n}\n\n@media (max-width: 768px) {\n    ul {\n        grid-auto-flow: row;\n        grid-template-columns: 1fr;\n    }\n}\n","Type":"Style","DefFinalizers":["Content|PrefixCSS"],"Name":"style","DefinitionName":"mws_DevLogNav_style","Source":"http://127.0.0.1:6627/libraries/mws/DevLogNav.css"}, 
...
mws_DocSidebar_style: {"Parent":"mws_DocSidebar","DefName":null,"Content":"li {\n    margin-left: 50px;\n}\n/*\nli.ginactive > ul::before,\nli.gactive > ul::before {\n    content: ' - ';\n    background: var(--highlight-color);\n    color: white;\n    text-decoration: none;\n}\n*/\nli.ginactive > a::before {\n    content: '+ ';\n}\n\n","Type":"Style","DefFinalizers":["Content|PrefixCSS"],"Name":"style","DefinitionName":"mws_DocSidebar_style","Source":"http://127.0.0.1:6627/libraries/mws/DocSidebar.css"}, 
...
docseg_Templating_PrepareCallback_template: {"Parent":"docseg_Templating_PrepareCallback","DefName":null,"Content":"\n    <input name=\"perc\" [state.bind]=\"\">% of\n    <input name=\"total\" [state.bind]=\"\">\n    is: {{ script.calcResult }}\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"docseg_Templating_PrepareCallback_template"}, 
...
docseg_Templating_PrepareCallback_style: {"Parent":"docseg_Templating_PrepareCallback","DefName":null,"Content":"\n    input { display: inline; width: 25px }\n","Type":"Style","DefFinalizers":["Content|PrefixCSS"],"Name":"style","DefinitionName":"docseg_Templating_PrepareCallback_style"}, 

docseg_Templating_Comments_template: {"Parent":"docseg_Templating_Comments","DefName":null,"Content":"\n    <h1>hello {# greeting #}</h1>\n    {% comment %}\n      {% if a %}<div>{{ b }}</div>{% endif %}\n      <h3>{{ state.items|first }}</h3>\n    {% endcomment %}\n    <p>Below the greeting...</p>\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"docseg_Templating_Comments_template"}, 

docseg_Templating_Escaping_template: {"Parent":"docseg_Templating_Escaping","DefName":null,"Content":"\n<p>User \"<em>{{ state.username }}</em>\" sent a message:</p>\n<div class=\"msgcontent\">\n    {{ state.content|safe }}\n</div>\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"docseg_Templating_Escaping_template"}, 
...
docseg_Templating_Escaping_style: {"Parent":"docseg_Templating_Escaping","DefName":null,"Content":"\n    .msgcontent {\n        background: #999;\n        padding: 10px;\n        margin: 10px;\n    }\n","Type":"Style","DefFinalizers":["Content|PrefixCSS"],"Name":"style","DefinitionName":"docseg_Templating_Escaping_style"}, 

docseg_Tutorial_P1_template: {"Parent":"docseg_Tutorial_P1","DefName":null,"Content":"\nHello <strong>Modulo</strong> World!\n<p class=\"neat\">Any HTML can be here!</p>\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"docseg_Tutorial_P1_template"}, 

docseg_Tutorial_P1_style: {"Parent":"docseg_Tutorial_P1","DefName":null,"Content":"\n/* ...and any CSS here! */\nstrong {\n    color: blue;\n}\n.neat {\n    font-variant: small-caps;\n}\n:host { /* styles the entire component */\n    display: inline-block;\n    background-color: cornsilk;\n    padding: 5px;\n    box-shadow: 10px 10px 0 0 turquoise;\n}\n","Type":"Style","DefFinalizers":["Content|PrefixCSS"],"Name":"style","DefinitionName":"docseg_Tutorial_P1_style"}, 

docseg_Tutorial_P2_template: {"Parent":"docseg_Tutorial_P2","DefName":null,"Content":"\n    <p>Trying out the button...</p>\n    <x-examplebtn label=\"Button Example\" shape=\"square\"></x-examplebtn>\n\n    <p>Another button...</p>\n    <x-examplebtn label=\"Example 2: Rounded\" shape=\"round\"></x-examplebtn>\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"docseg_Tutorial_P2_template"}, 

docseg_Tutorial_P2_filters_demo_template: {"Parent":"docseg_Tutorial_P2_filters_demo","DefName":null,"Content":"\n    <p>Trying out the button...</p>\n    <x-examplebtn label=\"Button Example\" shape=\"square\"></x-examplebtn>\n\n    <p>Another button...</p>\n    <x-examplebtn label=\"Example 2: Rounded\" shape=\"round\"></x-examplebtn>\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"docseg_Tutorial_P2_filters_demo_template"}, 

docseg_Tutorial_P3_state_demo_template: {"Parent":"docseg_Tutorial_P3_state_demo","DefName":null,"Content":"\n<p>Nonsense poem:</p> <pre>Professor {{ state.verb|capfirst }} who\n{{ state.verb }}ed a {{ state.noun }},\ntaught {{ state.verb }}ing in\nthe City of {{ state.noun|capfirst }},\nto {{ state.count }} {{ state.noun }}s.\n</pre>\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"docseg_Tutorial_P3_state_demo_template"}, 
...
docseg_Tutorial_P3_state_demo_style: {"Parent":"docseg_Tutorial_P3_state_demo","DefName":null,"Content":"\n    :host {\n        font-size: 0.8rem;\n    }\n","Type":"Style","DefFinalizers":["Content|PrefixCSS"],"Name":"style","DefinitionName":"docseg_Tutorial_P3_state_demo_style"}, 

docseg_Tutorial_P3_state_bind_template: {"Parent":"docseg_Tutorial_P3_state_bind","DefName":null,"Content":"\n\n<div>\n    <label>Username:\n        <input [state.bind]=\"\" name=\"username\"></label>\n    <label>Color (\"green\" or \"blue\"):\n        <input [state.bind]=\"\" name=\"color\"></label>\n    <label>Opacity: <input [state.bind]=\"\" name=\"opacity\" type=\"number\" min=\"0\" max=\"1\" step=\"0.1\"></label>\n\n    <h5 style=\"\n            opacity: {{ state.opacity }};\n            color: {{ state.color|allow:'green,blue'|default:'red' }};\n        \">\n        {{ state.username|lower }}\n    </h5>\n</div>\n\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"docseg_Tutorial_P3_state_bind_template"}, 
...
eg_Simple_template: {"Parent":"eg_Simple","DefName":null,"Content":"\n    Components can use any number of <strong>CParts</strong>.\n    Here we use only <em>Style</em> and <em>Template</em>.\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"eg_Simple_template"}, 

eg_Simple_style: {"Parent":"eg_Simple","DefName":null,"Content":"\n    em { color: darkgreen; }\n    * { text-decoration: underline; }\n","Type":"Style","DefFinalizers":["Content|PrefixCSS"],"Name":"style","DefinitionName":"eg_Simple_style"}, 

eg_ToDo_template: {"Parent":"eg_ToDo","DefName":null,"Content":"\n<ol>\n    {% for item in state.list %}\n        <li>{{ item }}</li>\n    {% endfor %}\n    <li>\n        <input [state.bind]=\"\" name=\"text\">\n        <button @click:=\"script.addItem\">Add</button>\n    </li>\n</ol>\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"eg_ToDo_template"}, 
...
eg_DateNumberPicker_template: {"Parent":"eg_DateNumberPicker","DefName":null,"Content":"\n    <p>ISO: <tt>{{ state.year }}-{{ state.month }}-{{ state.day }}</tt></p>\n    {% for part in state.ordering %}\n        <label>\n            {{ state|get:part }}\n            <div>\n                <button @click:=\"script.next\" payload=\"{{ part }}\">↑</button>\n                <button @click:=\"script.previous\" payload=\"{{ part }}\">↓</button>\n            </div>\n        </label>\n    {% endfor %}\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"eg_DateNumberPicker_template"}, 
...
eg_DateNumberPicker_style: {"Parent":"eg_DateNumberPicker","DefName":null,"Content":"\n    :host {\n        border: 1px solid black;\n        padding: 10px;\n        margin: 10px;\n        margin-left: 0;\n        display: flex;\n        flex-wrap: wrap;\n        font-weight: bold;\n    }\n    div {\n        float: right;\n    }\n    label {\n        display: block;\n        width: 100%;\n    }\n","Type":"Style","DefFinalizers":["Content|PrefixCSS"],"Name":"style","DefinitionName":"eg_DateNumberPicker_style"}, 

eg_PrimeSieve_template: {"Parent":"eg_PrimeSieve","DefName":null,"Content":"\n  <div class=\"grid\">\n    {% for i in script.exports.range %}\n      <div @mouseover:=\"script.setNum\" class=\"\n            {# If-statements to check divisibility in template: #}\n            {% if state.number == i %}number{% endif %}\n            {% if state.number lt i %}hidden{% else %}\n              {% if state.number|divisibleby:i %}whole{% endif %}\n            {% endif %}\n        \">{{ i }}</div>\n    {% endfor %}\n  </div>\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"eg_PrimeSieve_template"}, 
...
eg_FlexibleFormWithAPI_template: {"Parent":"eg_FlexibleFormWithAPI","DefName":null,"Content":"\n    <form>\n        {% for field in state.fields %}\n            <div class=\"field-pair\">\n                <label for=\"{{ field }}_{{ component.id }}\">\n                    <strong>{{ field|capfirst }}:</strong>\n                </label>\n                <input [state.bind]=\"\" type=\"{% if state|get:field|type == &quot;number&quot; %}number{% else %}text{% endif %}\" name=\"{{ field }}\" id=\"{{ field }}_{{ component.id }}\">\n            </div>\n        {% endfor %}\n        <button @click:=\"script.submit\">Post comment</button>\n        <hr>\n\n        {% for post in state.posts|reversed %}\n            <p>\n                {{ post.userId }}:\n                <strong>{{ post.title|truncate:15 }}</strong>\n                {{ post.body|truncate:18 }}\n            </p>\n        {% endfor %}\n    </form>\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"eg_FlexibleFormWithAPI_template"}, 
...
eg_OscillatingGraph_style: {"Parent":"eg_OscillatingGraph","DefName":null,"Content":"\n    input {\n        width: 50px;\n    }\n","Type":"Style","DefFinalizers":["Content|PrefixCSS"],"Name":"style","DefinitionName":"eg_OscillatingGraph_style"}, 

eg_Search_template: {"Parent":"eg_Search","DefName":null,"Content":"\n  <input [state.bind]=\"\" name=\"search\">\n  <button @click:=\"script.doSearch\">Go</button>\n  {% if state.loading %}<em>Loading...</em>{% endif %}\n  <ol>\n    {% for item in state.results %}\n      <li>\n        <img src=\"{{ item.cover }}\">\n        <strong>{{ item.title }}</strong>\n      </li>\n    {% endfor %}\n  </ol>\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"eg_Search_template"}, 
...
eg_SearchBox_template: {"Parent":"eg_SearchBox","DefName":null,"Content":"\n<p>Type a book name for \"search as you type\"\n(e.g. try “the lord of the rings”)</p>\n\n<input [state.bind]=\"\" name=\"search\" @keyup:=\"script.typingCallback\">\n\n<div class=\"results {% if state.search.length gt 0 %}\n                      visible {% endif %}\">\n  <div class=\"results-container\">\n    {% if state.loading %}\n      <img src=\"{{ staticdata.gif }}\" alt=\"loading\">\n    {% else %}\n      {% for result in state.results %}\n        <div class=\"result\">\n          <img src=\"{{ staticdata.cover|add:result.cover_i }}-S.jpg\"> <label>{{ result.title }}</label>\n        </div>\n      {% empty %}\n        <p>No books found.</p>\n      {% endfor %}\n    {% endif %}\n  </div>\n</div>\n","Type":"Template","TemplatePrebuild":"yes","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"eg_SearchBox_template"}, 
...
eg_ConwayGameOfLife_style: {"Parent":"eg_ConwayGameOfLife","DefName":null,"Content":"\n    :host {\n        display: flex;\n    }\n    .grid {\n        display: grid;\n        grid-template-columns: repeat(24, 5px);\n        margin: -2px;\n        grid-gap: 1px;\n    }\n    .grid > div {\n        background: white;\n        width: 5px;\n        height: 5px;\n    }\n    input, button {\n        width: 40px;\n    }\n","Type":"Style","DefFinalizers":["Content|PrefixCSS"],"Name":"style","DefinitionName":"eg_ConwayGameOfLife_style"}, 
 };
