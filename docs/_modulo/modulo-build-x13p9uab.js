...
window.moduloBuild.modules["xxpfb13f"] = function x_DemoModal (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, x_DemoModal);
        window.customElements.define(def.TagName, x_DemoModal);
        return x_DemoModal;
    
};
window.moduloBuild.nameToHash.x_DemoModal = "xxpfb13f";

window.moduloBuild.modules["x151hoj2"] = function x_DemoChart (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, x_DemoChart);
        window.customElements.define(def.TagName, x_DemoChart);
        return x_DemoChart;
    
};
window.moduloBuild.nameToHash.x_DemoChart = "x151hoj2";

window.moduloBuild.modules["xxxjnsmn"] = function x_ExampleBtn (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, x_ExampleBtn);
        window.customElements.define(def.TagName, x_ExampleBtn);
        return x_ExampleBtn;
    
};
window.moduloBuild.nameToHash.x_ExampleBtn = "xxxjnsmn";

window.moduloBuild.modules["x1r4nctp"] = function x_DemoSelector (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, x_DemoSelector);
        window.customElements.define(def.TagName, x_DemoSelector);
        return x_DemoSelector;
    
};
window.moduloBuild.nameToHash.x_DemoSelector = "x1r4nctp";
...
window.moduloBuild.modules["x191astr"] = function mws_Page (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, mws_Page);
        window.customElements.define(def.TagName, mws_Page);
        return mws_Page;
    
};
window.moduloBuild.nameToHash.mws_Page = "x191astr";

window.moduloBuild.modules["xx95jsjv"] = function mws_ProjectInfo (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, mws_ProjectInfo);
        window.customElements.define(def.TagName, mws_ProjectInfo);
        return mws_ProjectInfo;
    
};
window.moduloBuild.nameToHash.mws_ProjectInfo = "xx95jsjv";

window.moduloBuild.modules["x15gcnek"] = function mws_DevLogNav (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, mws_DevLogNav);
        window.customElements.define(def.TagName, mws_DevLogNav);
        return mws_DevLogNav;
    
};
window.moduloBuild.nameToHash.mws_DevLogNav = "x15gcnek";

window.moduloBuild.modules["x1k6jtfq"] = function mws_DocSidebar (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, mws_DocSidebar);
        window.customElements.define(def.TagName, mws_DocSidebar);
        return mws_DocSidebar;
    
};
window.moduloBuild.nameToHash.mws_DocSidebar = "x1k6jtfq";

window.moduloBuild.modules["x1kue0u9"] = function mws_Demo (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, mws_Demo);
        window.customElements.define(def.TagName, mws_Demo);
        return mws_Demo;
    
};
window.moduloBuild.nameToHash.mws_Demo = "x1kue0u9";

window.moduloBuild.modules["x1f5mjvu"] = function mws_AllExamples (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, mws_AllExamples);
        window.customElements.define(def.TagName, mws_AllExamples);
        return mws_AllExamples;
    
};
window.moduloBuild.nameToHash.mws_AllExamples = "x1f5mjvu";

window.moduloBuild.modules["xxigi01t"] = function mws_Section (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, mws_Section);
        window.customElements.define(def.TagName, mws_Section);
        return mws_Section;
    
};
window.moduloBuild.nameToHash.mws_Section = "xxigi01t";
...
window.moduloBuild.modules["x1qnckrq"] = function mws_DocSidebar_script (modulo) {
...
window.moduloBuild.nameToHash.mws_DocSidebar_script = "x1qnckrq";

window.moduloBuild.modules["x1ai155a"] = function mws_Demo_script (modulo) {
...
window.moduloBuild.modules["x1ekkph7"] = function docseg_Templating_1 (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, docseg_Templating_1);
        window.customElements.define(def.TagName, docseg_Templating_1);
        return docseg_Templating_1;
    
};
window.moduloBuild.nameToHash.docseg_Templating_1 = "x1ekkph7";

window.moduloBuild.modules["x1d0lm7c"] = function docseg_Templating_PrepareCallback (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, docseg_Templating_PrepareCallback);
        window.customElements.define(def.TagName, docseg_Templating_PrepareCallback);
        return docseg_Templating_PrepareCallback;
    
};
window.moduloBuild.nameToHash.docseg_Templating_PrepareCallback = "x1d0lm7c";

window.moduloBuild.modules["xxr282hq"] = function docseg_Templating_Comments (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, docseg_Templating_Comments);
        window.customElements.define(def.TagName, docseg_Templating_Comments);
        return docseg_Templating_Comments;
    
};
window.moduloBuild.nameToHash.docseg_Templating_Comments = "xxr282hq";

window.moduloBuild.modules["x11n9f38"] = function docseg_Templating_Escaping (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, docseg_Templating_Escaping);
        window.customElements.define(def.TagName, docseg_Templating_Escaping);
        return docseg_Templating_Escaping;
    
};
window.moduloBuild.nameToHash.docseg_Templating_Escaping = "x11n9f38";

window.moduloBuild.modules["xxvb81tk"] = function docseg_Tutorial_P1 (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, docseg_Tutorial_P1);
        window.customElements.define(def.TagName, docseg_Tutorial_P1);
        return docseg_Tutorial_P1;
    
};
window.moduloBuild.nameToHash.docseg_Tutorial_P1 = "xxvb81tk";

window.moduloBuild.modules["xx85njvf"] = function docseg_Tutorial_P2 (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, docseg_Tutorial_P2);
        window.customElements.define(def.TagName, docseg_Tutorial_P2);
        return docseg_Tutorial_P2;
    
};
window.moduloBuild.nameToHash.docseg_Tutorial_P2 = "xx85njvf";

window.moduloBuild.modules["xx7h5unj"] = function docseg_Tutorial_P2_filters_demo (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, docseg_Tutorial_P2_filters_demo);
        window.customElements.define(def.TagName, docseg_Tutorial_P2_filters_demo);
        return docseg_Tutorial_P2_filters_demo;
    
};
window.moduloBuild.nameToHash.docseg_Tutorial_P2_filters_demo = "xx7h5unj";

window.moduloBuild.modules["x1pd9q54"] = function docseg_Tutorial_P3_state_demo (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, docseg_Tutorial_P3_state_demo);
        window.customElements.define(def.TagName, docseg_Tutorial_P3_state_demo);
        return docseg_Tutorial_P3_state_demo;
    
};
window.moduloBuild.nameToHash.docseg_Tutorial_P3_state_demo = "x1pd9q54";

window.moduloBuild.modules["x1hmr3nm"] = function docseg_Tutorial_P3_state_bind (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, docseg_Tutorial_P3_state_bind);
        window.customElements.define(def.TagName, docseg_Tutorial_P3_state_bind);
        return docseg_Tutorial_P3_state_bind;
    
};
window.moduloBuild.nameToHash.docseg_Tutorial_P3_state_bind = "x1hmr3nm";
...
window.moduloBuild.modules["xxupjk9l"] = function eg_Hello (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_Hello);
        window.customElements.define(def.TagName, eg_Hello);
        return eg_Hello;
    
};
window.moduloBuild.nameToHash.eg_Hello = "xxupjk9l";

window.moduloBuild.modules["xxrhos83"] = function eg_Simple (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_Simple);
        window.customElements.define(def.TagName, eg_Simple);
        return eg_Simple;
    
};
window.moduloBuild.nameToHash.eg_Simple = "xxrhos83";

window.moduloBuild.modules["xx5qdh5h"] = function eg_ToDo (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_ToDo);
        window.customElements.define(def.TagName, eg_ToDo);
        return eg_ToDo;
    
};
window.moduloBuild.nameToHash.eg_ToDo = "xx5qdh5h";

window.moduloBuild.modules["xxo8lpij"] = function eg_JSON (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_JSON);
        window.customElements.define(def.TagName, eg_JSON);
        return eg_JSON;
    
};
window.moduloBuild.nameToHash.eg_JSON = "xxo8lpij";

window.moduloBuild.modules["x124cpbo"] = function eg_JSONArray (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_JSONArray);
        window.customElements.define(def.TagName, eg_JSONArray);
        return eg_JSONArray;
    
};
window.moduloBuild.nameToHash.eg_JSONArray = "x124cpbo";

window.moduloBuild.modules["x1teq8fq"] = function eg_GitHubAPI (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_GitHubAPI);
        window.customElements.define(def.TagName, eg_GitHubAPI);
        return eg_GitHubAPI;
    
};
window.moduloBuild.nameToHash.eg_GitHubAPI = "x1teq8fq";

window.moduloBuild.modules["x1bekpk5"] = function eg_ColorSelector (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_ColorSelector);
        window.customElements.define(def.TagName, eg_ColorSelector);
        return eg_ColorSelector;
    
};
window.moduloBuild.nameToHash.eg_ColorSelector = "x1bekpk5";

window.moduloBuild.modules["x1d3p8tg"] = function eg_DateNumberPicker (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_DateNumberPicker);
        window.customElements.define(def.TagName, eg_DateNumberPicker);
        return eg_DateNumberPicker;
    
};
window.moduloBuild.nameToHash.eg_DateNumberPicker = "x1d3p8tg";

window.moduloBuild.modules["xxbr6cba"] = function eg_PrimeSieve (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_PrimeSieve);
        window.customElements.define(def.TagName, eg_PrimeSieve);
        return eg_PrimeSieve;
    
};
window.moduloBuild.nameToHash.eg_PrimeSieve = "xxbr6cba";

window.moduloBuild.modules["xxo638jh"] = function eg_Scatter (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_Scatter);
        window.customElements.define(def.TagName, eg_Scatter);
        return eg_Scatter;
    
};
window.moduloBuild.nameToHash.eg_Scatter = "xxo638jh";

window.moduloBuild.modules["x1ovegn6"] = function eg_FlexibleForm (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_FlexibleForm);
        window.customElements.define(def.TagName, eg_FlexibleForm);
        return eg_FlexibleForm;
    
};
window.moduloBuild.nameToHash.eg_FlexibleForm = "x1ovegn6";

window.moduloBuild.modules["x1t172bs"] = function eg_FlexibleFormWithAPI (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_FlexibleFormWithAPI);
        window.customElements.define(def.TagName, eg_FlexibleFormWithAPI);
        return eg_FlexibleFormWithAPI;
    
};
window.moduloBuild.nameToHash.eg_FlexibleFormWithAPI = "x1t172bs";

window.moduloBuild.modules["x1avssv1"] = function eg_Components (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_Components);
        window.customElements.define(def.TagName, eg_Components);
        return eg_Components;
    
};
window.moduloBuild.nameToHash.eg_Components = "x1avssv1";

window.moduloBuild.modules["xxgmlldk"] = function eg_OscillatingGraph (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_OscillatingGraph);
        window.customElements.define(def.TagName, eg_OscillatingGraph);
        return eg_OscillatingGraph;
    
};
window.moduloBuild.nameToHash.eg_OscillatingGraph = "xxgmlldk";

window.moduloBuild.modules["xxo3b9id"] = function eg_Search (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_Search);
        window.customElements.define(def.TagName, eg_Search);
        return eg_Search;
    
};
window.moduloBuild.nameToHash.eg_Search = "xxo3b9id";

window.moduloBuild.modules["x15i6ec2"] = function eg_SearchBox (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_SearchBox);
        window.customElements.define(def.TagName, eg_SearchBox);
        return eg_SearchBox;
    
};
window.moduloBuild.nameToHash.eg_SearchBox = "x15i6ec2";

window.moduloBuild.modules["x1bh86eb"] = function eg_WorldMap (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_WorldMap);
        window.customElements.define(def.TagName, eg_WorldMap);
        return eg_WorldMap;
    
};
window.moduloBuild.nameToHash.eg_WorldMap = "x1bh86eb";

window.moduloBuild.modules["xxs0uo1c"] = function eg_Memory (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_Memory);
        window.customElements.define(def.TagName, eg_Memory);
        return eg_Memory;
    
};
window.moduloBuild.nameToHash.eg_Memory = "xxs0uo1c";

window.moduloBuild.modules["x18fmfmt"] = function eg_ConwayGameOfLife (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, eg_ConwayGameOfLife);
        window.customElements.define(def.TagName, eg_ConwayGameOfLife);
        return eg_ConwayGameOfLife;
    
};
window.moduloBuild.nameToHash.eg_ConwayGameOfLife = "x18fmfmt";
...
window.moduloBuild.modules["x119ugke"] = function eg_DateNumberPicker_script (modulo) {
var script = { exports: {} }; var state;
...
window.moduloBuild.nameToHash.eg_DateNumberPicker_script = "x119ugke";
...
window.moduloBuild.modules["x1ej84u5"] = function eg_Components_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n\n<x-demomodal button=\"Show data\" title=\"Further information\">\n    <h2>Example chart:</h2>\n    <x-demochart data:=\"[50, 13, 100]\"></x-demochart>\n</x-demomodal>\n\n<x-demochart data:=\"[1, 2, 3, 5, 8]\"></x-demochart>\n\n<x-demomodal button=\"Bio: Nicholas Cage\" title=\"Biography\">\n    <p>Prolific and varied Hollywood actor</p>\n    <img src=\"https://i.imgur.com/hJwIMx7.png\">\n</x-demomodal>\n\n\n"); // "<x-demomodal button=\"Show data\" title=\"Further information\"><h2>Example chart:</h2><x-demochart data:=\"[50, 13, 100]\"></x-demochart></x-demomodal><x-demochart data:=\"[1, 2, 3, 5, 8]\"></x-demochart><x-demomodal button=\"Bio: Nicholas Cage\" title=\"Biography\"><p>Prolific and varied Hollywood actor</p><img src=\"https://i.imgur.com/hJwIMx7.png\"></x-demomodal>"

return OUT.join(""); };
};
window.moduloBuild.nameToHash.eg_Components_template = "x1ej84u5";
...
window.moduloBuild.modules["x1spom4d"] = function eg_ConwayGameOfLife_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n  <div class=\"grid\">\n    "); // "<div class=\"grid\">"
  var ARR0=CTX.script.exports.range;for (var KEY in ARR0) {CTX. i=ARR0[KEY]; // "for i in script.exports.range"
  OUT.push("\n        "); // ""
...
x_DemoModal: {"Parent":"x","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"x","name":"DemoModal","Name":"DemoModal","DefinitionName":"x_DemoModal","ChildrenNames":["x_DemoModal_props","x_DemoModal_template","x_DemoModal_state","x_DemoModal_script","x_DemoModal_style"],"TagName":"x-demomodal"}, 

x_DemoChart: {"Parent":"x","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"x","name":"DemoChart","Name":"DemoChart","DefinitionName":"x_DemoChart","ChildrenNames":["x_DemoChart_props","x_DemoChart_template","x_DemoChart_script","x_DemoChart_style"],"TagName":"x-demochart"}, 

x_ExampleBtn: {"Parent":"x","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"x","name":"ExampleBtn","Name":"ExampleBtn","DefinitionName":"x_ExampleBtn","ChildrenNames":["x_ExampleBtn_props","x_ExampleBtn_template","x_ExampleBtn_style"],"TagName":"x-examplebtn"}, 

x_DemoSelector: {"Parent":"x","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"x","name":"DemoSelector","Name":"DemoSelector","DefinitionName":"x_DemoSelector","ChildrenNames":["x_DemoSelector_props","x_DemoSelector_template","x_DemoSelector_state","x_DemoSelector_script","x_DemoSelector_style"],"TagName":"x-demoselector"}, 

x_DemoModal_props: {"Parent":"x_DemoModal","DefName":null,"Type":"Props","Content":"","button":"","title":"","Name":"props","DefinitionName":"x_DemoModal_props"}, 
...
x_DemoModal_state: {"Parent":"x_DemoModal","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","visible":false,"Name":"state","DefinitionName":"x_DemoModal_state"}, 

x_DemoModal_script: {"Parent":"x_DemoModal","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"x_DemoModal_script","Directives":[]}, 
...
x_DemoChart_props: {"Parent":"x_DemoChart","DefName":null,"Type":"Props","Content":"","data":"","animated":"","Name":"props","DefinitionName":"x_DemoChart_props"}, 
...
x_DemoChart_script: {"Parent":"x_DemoChart","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"x_DemoChart_script","Directives":[]}, 
...
x_ExampleBtn_props: {"Parent":"x_ExampleBtn","DefName":null,"Type":"Props","Content":"","label":"","shape":"","Name":"props","DefinitionName":"x_ExampleBtn_props"}, 
...
x_DemoSelector_props: {"Parent":"x_DemoSelector","DefName":null,"Type":"Props","Content":"","onchange":"","options":"","name":"","Name":"props","DefinitionName":"x_DemoSelector_props"}, 
...
x_DemoSelector_state: {"Parent":"x_DemoSelector","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","value":"","Name":"state","DefinitionName":"x_DemoSelector_state"}, 

x_DemoSelector_script: {"Parent":"x_DemoSelector","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"x_DemoSelector_script","Directives":[]}, 
...
mws_Page: {"Parent":"mws","DefName":null,"mode":"vanish-into-document","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"mws","name":"Page","Name":"Page","DefinitionName":"mws_Page","ChildrenNames":["mws_Page_props","mws_Page_style","mws_Page_template","mws_Page_script"],"TagName":"mws-page"}, 

mws_ProjectInfo: {"Parent":"mws","DefName":null,"mode":"vanish","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"mws","name":"ProjectInfo","Name":"ProjectInfo","DefinitionName":"mws_ProjectInfo","ChildrenNames":["mws_ProjectInfo_props","mws_ProjectInfo_staticdata","mws_ProjectInfo_template"],"TagName":"mws-projectinfo"}, 

mws_DevLogNav: {"Parent":"mws","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"mws","name":"DevLogNav","Name":"DevLogNav","DefinitionName":"mws_DevLogNav","ChildrenNames":["mws_DevLogNav_props","mws_DevLogNav_template","mws_DevLogNav_state","mws_DevLogNav_style"],"TagName":"mws-devlognav"}, 

mws_DocSidebar: {"Parent":"mws","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"mws","name":"DocSidebar","Name":"DocSidebar","DefinitionName":"mws_DocSidebar","ChildrenNames":["mws_DocSidebar_props","mws_DocSidebar_template","mws_DocSidebar_state","mws_DocSidebar_script","mws_DocSidebar_style"],"TagName":"mws-docsidebar"}, 

mws_Demo: {"Parent":"mws","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"mws","name":"Demo","Name":"Demo","DefinitionName":"mws_Demo","ChildrenNames":["mws_Demo_props","mws_Demo_template","mws_Demo_state","mws_Demo_script","mws_Demo_style"],"TagName":"mws-demo"}, 

mws_AllExamples: {"Parent":"mws","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"mws","name":"AllExamples","Name":"AllExamples","DefinitionName":"mws_AllExamples","ChildrenNames":["mws_AllExamples_template","mws_AllExamples_state","mws_AllExamples_script","mws_AllExamples_style"],"TagName":"mws-allexamples"}, 

mws_Section: {"Parent":"mws","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"mws","name":"Section","Name":"Section","DefinitionName":"mws_Section","ChildrenNames":["mws_Section_props","mws_Section_template","mws_Section_style"],"TagName":"mws-section"}, 

mws_Page_props: {"Parent":"mws_Page","DefName":null,"Type":"Props","Content":"","navbar":"","docbarselected":"","pagetitle":"","Name":"props","DefinitionName":"mws_Page_props"}, 
...
mws_Page_script: {"Parent":"mws_Page","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"mws_Page_script","Directives":[]}, 

mws_ProjectInfo_props: {"Parent":"mws_ProjectInfo","DefName":null,"Type":"Props","Content":"","version":"","Name":"props","DefinitionName":"mws_ProjectInfo_props"}, 

mws_ProjectInfo_staticdata: {"Parent":"mws_ProjectInfo","DefName":null,"Type":"StaticData","DefLoaders":["DefinedAs","DataType","Src"],"DefBuilders":["ContentCSV","ContentTXT","ContentJSON","ContentJS"],"DefFinalizers":["Code","RequireData"],"Content":"{\n  \"name\": \"mdu.js\",\n  \"author\": \"michaelb\",\n  \"version\": \"0.0.40\",\n  \"description\": \"Lightweight, easy-to-learn Web Component JavaScript framework\",\n  \"homepage\": \"https://modulojs.org/\",\n  \"main\": \"./src/Modulo.js\",\n  \"bin\": {\n    \"mdu-cli\": \"modulocli/modulocli.js\",\n    \"modulocli\": \"modulocli/modulocli.js\"\n  },\n  \"scripts\": {\n    \"serve\": \"npm run cli -- serve\",\n    \"srcserve\": \"npm run cli -- srcserve\",\n    \"start\": \"npm run cli -- devserve\",\n    \"build\": \"npm run cli -- ssg -f\",\n    \"build-docs\": \"npm run cli -- ssg\",\n    \"cli\": \"node ./modulocli/modulocli.js\",\n    \"test\": \"npm run cli -- test\"\n  },\n  \"peerDependencies\": {\n    \"express\": \"^4.18.2\",\n    \"node-watch\": \"^0.7.2\",\n    \"puppeteer\": \"^13.7.0\"\n  },\n  \"repository\": {\n    \"type\": \"git\",\n    \"url\": \"git+https://github.com/modulojs/modulo.git\"\n  },\n  \"exports\": {\n    \"require\": \"./src/Modulo.js\"\n  },\n  \"keywords\": [\n    \"UI\",\n    \"templates\",\n    \"templating\",\n    \"components\",\n    \"framework\"\n  ],\n  \"files\": [\n    \"src/*\",\n    \"modulocli/*\",\n    \"modulocli/**/*\",\n    \"mdu/*\",\n    \"mdu/**/*\"\n  ],\n  \"license\": \"LGPL-2.1\",\n  \"bugs\": {\n    \"url\": \"https://github.com/modulojs/modulo/issues\"\n  }\n}\n","Name":"staticdata","DefinitionName":"mws_ProjectInfo_staticdata","Source":"https://raw.githubusercontent.com/modulojs/modulo/main/package.json","data":{"name":"mdu.js","author":"michaelb","version":"0.0.40","description":"Lightweight, easy-to-learn Web Component JavaScript framework","homepage":"https://modulojs.org/","main":"./src/Modulo.js","bin":{"mdu-cli":"modulocli/modulocli.js","modulocli":"modulocli/modulocli.js"},"scripts":{"serve":"npm run cli -- serve","srcserve":"npm run cli -- srcserve","start":"npm run cli -- devserve","build":"npm run cli -- ssg -f","build-docs":"npm run cli -- ssg","cli":"node ./modulocli/modulocli.js","test":"npm run cli -- test"},"peerDependencies":{"express":"^4.18.2","node-watch":"^0.7.2","puppeteer":"^13.7.0"},"repository":{"type":"git","url":"git+https://github.com/modulojs/modulo.git"},"exports":{"require":"./src/Modulo.js"},"keywords":["UI","templates","templating","components","framework"],"files":["src/*","modulocli/*","modulocli/**/*","mdu/*","mdu/**/*"],"license":"LGPL-2.1","bugs":{"url":"https://github.com/modulojs/modulo/issues"}}}, 
...
mws_DevLogNav_props: {"Parent":"mws_DevLogNav","DefName":null,"Type":"Props","Content":"","fn":"","Name":"props","DefinitionName":"mws_DevLogNav_props"}, 
...
mws_DevLogNav_state: {"Parent":"mws_DevLogNav","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","nav":[["2022-12","Intro slides"],["2022-09","Alpha release"],["2022-07","HTML-first"],["2022-03","Prealpha"],["2021-09","Thoughts on framework design"],["2021-01","FAQ"]],"Name":"state","DefinitionName":"mws_DevLogNav_state"}, 
...
mws_DocSidebar_props: {"Parent":"mws_DocSidebar","DefName":null,"Type":"Props","Content":"","path":"","showall":"","Name":"props","DefinitionName":"mws_DocSidebar_props"}, 
...
mws_DocSidebar_state: {"Parent":"mws_DocSidebar","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","menu":[],"Name":"state","DefinitionName":"mws_DocSidebar_state"}, 

mws_DocSidebar_script: {"Parent":"mws_DocSidebar","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"mws_DocSidebar_script","Source":"http://127.0.0.1:6627/libraries/mws/DocSidebar.js","Directives":[]}, 
...
mws_Demo_props: {"Parent":"mws_Demo","DefName":null,"Type":"Props","Content":"","text":"","text2":"","text3":"","ttitle":"","ttitle2":"","ttitle3":"","demotype":"","fromlibrary":"","Name":"props","DefinitionName":"mws_Demo_props"}, 
...
mws_Demo_state: {"Parent":"mws_Demo","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","tabs":[],"selected":null,"preview":"","text":"","nscounter":1,"showtoast":false,"toasttext":"","showpreview":false,"showclipboard":false,"showcomponentcopy":false,"fullscreen":false,"Name":"state","DefinitionName":"mws_Demo_state"}, 

mws_Demo_script: {"Parent":"mws_Demo","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"mws_Demo_script","Source":"http://127.0.0.1:6627/libraries/mws/Demo.js","Directives":["codemirrorMount","previewspotMount"]}, 
...
mws_AllExamples_state: {"Parent":"mws_AllExamples","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","selected":"","examples":[],"Name":"state","DefinitionName":"mws_AllExamples_state"}, 

mws_AllExamples_script: {"Parent":"mws_AllExamples","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"mws_AllExamples_script","Source":"http://127.0.0.1:6627/libraries/mws/AllExamples.js","Directives":[]}, 
...
mws_Section_props: {"Parent":"mws_Section","DefName":null,"Type":"Props","Content":"","name":"","Name":"props","DefinitionName":"mws_Section_props"}, 
...
docseg_Templating_1: {"Parent":"docseg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"docseg","name":"Templating_1","Name":"Templating_1","DefinitionName":"docseg_Templating_1","ChildrenNames":["docseg_Templating_1_template","docseg_Templating_1_state","docseg_Templating_1_script"],"TagName":"docseg-templating_1"}, 

docseg_Templating_PrepareCallback: {"Parent":"docseg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"docseg","name":"Templating_PrepareCallback","Name":"Templating_PrepareCallback","DefinitionName":"docseg_Templating_PrepareCallback","ChildrenNames":["docseg_Templating_PrepareCallback_template","docseg_Templating_PrepareCallback_state","docseg_Templating_PrepareCallback_script","docseg_Templating_PrepareCallback_style"],"TagName":"docseg-templating_preparecallback"}, 

docseg_Templating_Comments: {"Parent":"docseg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"docseg","name":"Templating_Comments","Name":"Templating_Comments","DefinitionName":"docseg_Templating_Comments","ChildrenNames":["docseg_Templating_Comments_template"],"TagName":"docseg-templating_comments"}, 

docseg_Templating_Escaping: {"Parent":"docseg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"docseg","name":"Templating_Escaping","Name":"Templating_Escaping","DefinitionName":"docseg_Templating_Escaping","ChildrenNames":["docseg_Templating_Escaping_template","docseg_Templating_Escaping_state","docseg_Templating_Escaping_style"],"TagName":"docseg-templating_escaping"}, 

docseg_Tutorial_P1: {"Parent":"docseg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"docseg","name":"Tutorial_P1","Name":"Tutorial_P1","DefinitionName":"docseg_Tutorial_P1","ChildrenNames":["docseg_Tutorial_P1_template","docseg_Tutorial_P1_style"],"TagName":"docseg-tutorial_p1"}, 

docseg_Tutorial_P2: {"Parent":"docseg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"docseg","name":"Tutorial_P2","Name":"Tutorial_P2","DefinitionName":"docseg_Tutorial_P2","ChildrenNames":["docseg_Tutorial_P2_template"],"TagName":"docseg-tutorial_p2"}, 

docseg_Tutorial_P2_filters_demo: {"Parent":"docseg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"docseg","name":"Tutorial_P2_filters_demo","Name":"Tutorial_P2_filters_demo","DefinitionName":"docseg_Tutorial_P2_filters_demo","ChildrenNames":["docseg_Tutorial_P2_filters_demo_template"],"TagName":"docseg-tutorial_p2_filters_demo"}, 

docseg_Tutorial_P3_state_demo: {"Parent":"docseg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"docseg","name":"Tutorial_P3_state_demo","Name":"Tutorial_P3_state_demo","DefinitionName":"docseg_Tutorial_P3_state_demo","ChildrenNames":["docseg_Tutorial_P3_state_demo_template","docseg_Tutorial_P3_state_demo_state","docseg_Tutorial_P3_state_demo_style"],"TagName":"docseg-tutorial_p3_state_demo"}, 

docseg_Tutorial_P3_state_bind: {"Parent":"docseg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"docseg","name":"Tutorial_P3_state_bind","Name":"Tutorial_P3_state_bind","DefinitionName":"docseg_Tutorial_P3_state_bind","ChildrenNames":["docseg_Tutorial_P3_state_bind_template","docseg_Tutorial_P3_state_bind_state"],"TagName":"docseg-tutorial_p3_state_bind"}, 
...
docseg_Templating_1_state: {"Parent":"docseg_Templating_1","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","count":42,"articles":[{"headline":"Modulo released!","tease":"The most exciting news of the century."},{"headline":"Can JS be fun again?"},{"headline":"MTL considered harmful","tease":"Why constructing JS is risky business."}],"Name":"state","DefinitionName":"docseg_Templating_1_state"}, 

docseg_Templating_1_script: {"Parent":"docseg_Templating_1","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"docseg_Templating_1_script","Directives":[]}, 
...
docseg_Templating_PrepareCallback_state: {"Parent":"docseg_Templating_PrepareCallback","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","perc":50,"total":30,"Name":"state","DefinitionName":"docseg_Templating_PrepareCallback_state"}, 

docseg_Templating_PrepareCallback_script: {"Parent":"docseg_Templating_PrepareCallback","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"docseg_Templating_PrepareCallback_script","Directives":[]}, 
...
docseg_Templating_Escaping_state: {"Parent":"docseg_Templating_Escaping","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","username":"Little <Bobby> <Drop> &tables","content":"\n        I <i>love</i> the classic <a target=\"_blank\"\n        href=\"https://xkcd.com/327/\">xkcd #327</a> on\n        the risk of trusting <b>user inputted data</b>\n    ","Name":"state","DefinitionName":"docseg_Templating_Escaping_state"}, 
...
docseg_Tutorial_P3_state_demo_state: {"Parent":"docseg_Tutorial_P3_state_demo","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","verb":"toot","noun":"kazoo","count":"two","Name":"state","DefinitionName":"docseg_Tutorial_P3_state_demo_state"}, 
...
docseg_Tutorial_P3_state_bind_state: {"Parent":"docseg_Tutorial_P3_state_bind","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","opacity":"0.5","color":"blue","username":"Testing_Username","Name":"state","DefinitionName":"docseg_Tutorial_P3_state_bind_state"}, 

eg_Hello: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"Hello","Name":"Hello","DefinitionName":"eg_Hello","ChildrenNames":["eg_Hello_template","eg_Hello_state","eg_Hello_script"],"TagName":"eg-hello"}, 

eg_Simple: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"Simple","Name":"Simple","DefinitionName":"eg_Simple","ChildrenNames":["eg_Simple_template","eg_Simple_style"],"TagName":"eg-simple"}, 

eg_ToDo: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"ToDo","Name":"ToDo","DefinitionName":"eg_ToDo","ChildrenNames":["eg_ToDo_template","eg_ToDo_state","eg_ToDo_script"],"TagName":"eg-todo"}, 

eg_JSON: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"JSON","Name":"JSON","DefinitionName":"eg_JSON","ChildrenNames":["eg_JSON_template","eg_JSON_staticdata"],"TagName":"eg-json"}, 

eg_JSONArray: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"JSONArray","Name":"JSONArray","DefinitionName":"eg_JSONArray","ChildrenNames":["eg_JSONArray_template","eg_JSONArray_staticdata"],"TagName":"eg-jsonarray"}, 

eg_GitHubAPI: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"GitHubAPI","Name":"GitHubAPI","DefinitionName":"eg_GitHubAPI","ChildrenNames":["eg_GitHubAPI_template","eg_GitHubAPI_state","eg_GitHubAPI_script"],"TagName":"eg-githubapi"}, 

eg_ColorSelector: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"ColorSelector","Name":"ColorSelector","DefinitionName":"eg_ColorSelector","ChildrenNames":["eg_ColorSelector_template","eg_ColorSelector_state"],"TagName":"eg-colorselector"}, 

eg_DateNumberPicker: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"DateNumberPicker","Name":"DateNumberPicker","DefinitionName":"eg_DateNumberPicker","ChildrenNames":["eg_DateNumberPicker_template","eg_DateNumberPicker_state","eg_DateNumberPicker_script","eg_DateNumberPicker_style"],"TagName":"eg-datenumberpicker"}, 

eg_PrimeSieve: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"PrimeSieve","Name":"PrimeSieve","DefinitionName":"eg_PrimeSieve","ChildrenNames":["eg_PrimeSieve_template","eg_PrimeSieve_state","eg_PrimeSieve_script","eg_PrimeSieve_style"],"TagName":"eg-primesieve"}, 

eg_Scatter: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"Scatter","Name":"Scatter","DefinitionName":"eg_Scatter","ChildrenNames":["eg_Scatter_template","eg_Scatter_staticdata","eg_Scatter_style"],"TagName":"eg-scatter"}, 

eg_FlexibleForm: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"FlexibleForm","Name":"FlexibleForm","DefinitionName":"eg_FlexibleForm","ChildrenNames":["eg_FlexibleForm_template","eg_FlexibleForm_state"],"TagName":"eg-flexibleform"}, 

eg_FlexibleFormWithAPI: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"FlexibleFormWithAPI","Name":"FlexibleFormWithAPI","DefinitionName":"eg_FlexibleFormWithAPI","ChildrenNames":["eg_FlexibleFormWithAPI_template","eg_FlexibleFormWithAPI_state","eg_FlexibleFormWithAPI_script"],"TagName":"eg-flexibleformwithapi"}, 

eg_Components: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"Components","Name":"Components","DefinitionName":"eg_Components","ChildrenNames":["eg_Components_template"],"TagName":"eg-components"}, 

eg_OscillatingGraph: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"OscillatingGraph","Name":"OscillatingGraph","DefinitionName":"eg_OscillatingGraph","ChildrenNames":["eg_OscillatingGraph_template","eg_OscillatingGraph_state","eg_OscillatingGraph_script","eg_OscillatingGraph_style"],"TagName":"eg-oscillatinggraph"}, 

eg_Search: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"Search","Name":"Search","DefinitionName":"eg_Search","ChildrenNames":["eg_Search_template","eg_Search_state","eg_Search_script"],"TagName":"eg-search"}, 

eg_SearchBox: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"SearchBox","Name":"SearchBox","DefinitionName":"eg_SearchBox","ChildrenNames":["eg_SearchBox_template","eg_SearchBox_state","eg_SearchBox_staticdata","eg_SearchBox_script","eg_SearchBox_style"],"TagName":"eg-searchbox"}, 

eg_WorldMap: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"WorldMap","Name":"WorldMap","DefinitionName":"eg_WorldMap","ChildrenNames":["eg_WorldMap_template","eg_WorldMap_staticdata","eg_WorldMap_style"],"TagName":"eg-worldmap"}, 

eg_Memory: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"Memory","Name":"Memory","DefinitionName":"eg_Memory","ChildrenNames":["eg_Memory_template","eg_Memory_state","eg_Memory_script","eg_Memory_style"],"TagName":"eg-memory"}, 

eg_ConwayGameOfLife: {"Parent":"eg","DefName":null,"mode":"regular","rerender":"event","engine":"Reconciler","Contains":"cparts","RenderObj":"component","DefLoaders":["DefinedAs","Src","Content"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"Directives":["slotLoad","eventMount","eventUnmount","dataPropMount","dataPropUnmount"],"Type":"Component","namespace":"eg","name":"ConwayGameOfLife","Name":"ConwayGameOfLife","DefinitionName":"eg_ConwayGameOfLife","ChildrenNames":["eg_ConwayGameOfLife_template","eg_ConwayGameOfLife_state","eg_ConwayGameOfLife_script","eg_ConwayGameOfLife_style"],"TagName":"eg-conwaygameoflife"}, 
...
eg_Hello_state: {"Parent":"eg_Hello","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","num":42,"Name":"state","DefinitionName":"eg_Hello_state"}, 

eg_Hello_script: {"Parent":"eg_Hello","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"eg_Hello_script","Directives":[]}, 
...
eg_ToDo_state: {"Parent":"eg_ToDo","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","list":["Milk","Bread","Candy"],"text":"Beer","Name":"state","DefinitionName":"eg_ToDo_state"}, 

eg_ToDo_script: {"Parent":"eg_ToDo","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"eg_ToDo_script","Directives":[]}, 
...
eg_GitHubAPI_state: {"Parent":"eg_GitHubAPI","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","search":"","name":"","location":"","bio":"","Name":"state","DefinitionName":"eg_GitHubAPI_state"}, 

eg_GitHubAPI_script: {"Parent":"eg_GitHubAPI","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"eg_GitHubAPI_script","Directives":[]}, 
...
eg_ColorSelector_state: {"Parent":"eg_ColorSelector","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","hue":130,"sat":50,"lum":50,"Name":"state","DefinitionName":"eg_ColorSelector_state"}, 
...
eg_DateNumberPicker_state: {"Parent":"eg_DateNumberPicker","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","day":1,"month":1,"year":2022,"ordering":["year","month","day"],"Name":"state","DefinitionName":"eg_DateNumberPicker_state"}, 

eg_DateNumberPicker_script: {"Parent":"eg_DateNumberPicker","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"eg_DateNumberPicker_script","Directives":[]}, 
...
eg_PrimeSieve_state: {"Parent":"eg_PrimeSieve","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","number":64,"Name":"state","DefinitionName":"eg_PrimeSieve_state"}, 

eg_PrimeSieve_script: {"Parent":"eg_PrimeSieve","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"eg_PrimeSieve_script","Directives":[]}, 
...
eg_FlexibleForm_state: {"Parent":"eg_FlexibleForm","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","name":"Spartacus","topic":"On the treatment of Thracian gladiators","subscribe":true,"private":false,"comment":"So, like, Romans claim to be all about virtue, but do you know what I think? I think they stink.","fields":["name","topic","comment","private","subscribe"],"Name":"state","DefinitionName":"eg_FlexibleForm_state"}, 
...
eg_FlexibleFormWithAPI_state: {"Parent":"eg_FlexibleFormWithAPI","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","user":1337,"topic":"On the treatment of Thracian gladiators","comment":"So, like, Romans claim to be all about virtue, but do you know what I think? I think they stink.","fields":["user","topic","comment"],"posts":[],"Name":"state","DefinitionName":"eg_FlexibleFormWithAPI_state"}, 

eg_FlexibleFormWithAPI_script: {"Parent":"eg_FlexibleFormWithAPI","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"eg_FlexibleFormWithAPI_script","Directives":[]}, 

eg_Components_template: {"Parent":"eg_Components","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"eg_Components_template","Hash":"Tx1ej84u5"}, 
...
eg_OscillatingGraph_state: {"Parent":"eg_OscillatingGraph","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","playing":false,"speed":10,"easing":"linear","align":"flex-end","tick":1,"width":10,"anim":10,"pulse":1,"offset":1,"data":[],"Name":"state","DefinitionName":"eg_OscillatingGraph_state"}, 

eg_OscillatingGraph_script: {"Parent":"eg_OscillatingGraph","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"eg_OscillatingGraph_script","Directives":[]}, 
...
eg_Search_state: {"Parent":"eg_Search","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","search":"the lord of the rings","loading":false,"results":[],"Name":"state","DefinitionName":"eg_Search_state"}, 

eg_Search_script: {"Parent":"eg_Search","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"eg_Search_script","Directives":[]}, 
...
eg_SearchBox_state: {"Parent":"eg_SearchBox","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","search":"","results":[],"loading":false,"Name":"state","DefinitionName":"eg_SearchBox_state"}, 

eg_SearchBox_staticdata: {"Parent":"eg_SearchBox","DefName":null,"Type":"StaticData","DefLoaders":["DefinedAs","DataType","Src"],"DefBuilders":["ContentCSV","ContentTXT","ContentJSON","ContentJS"],"DefFinalizers":["Code","RequireData"],"Content":"\n{\n  apiBase: 'https://openlibrary.org/search.json',\n  cover: 'https://covers.openlibrary.org/b/id/',\n  gif: 'https://cdnjs.cloudflare.com/ajax/libs/' +\n    'semantic-ui/0.16.1/images/loader-large.gif'\n}\n","Name":"staticdata","DefinitionName":"eg_SearchBox_staticdata","data":{"apiBase":"https://openlibrary.org/search.json","cover":"https://covers.openlibrary.org/b/id/","gif":"https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/0.16.1/images/loader-large.gif"}}, 

eg_SearchBox_script: {"Parent":"eg_SearchBox","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"eg_SearchBox_script","Directives":[]}, 
...
eg_WorldMap_staticdata: {"Parent":"eg_WorldMap","DefName":null,"Type":"StaticData","DefLoaders":["DefinedAs","DataType","Src"],"DefBuilders":["ContentCSV","ContentTXT","ContentJSON","ContentJS"],"DefFinalizers":["Code","RequireData"],"Content":"[\n  {\n    \"id\": 1,\n    \"name\": \"Leanne Graham\",\n    \"username\": \"Bret\",\n    \"email\": \"Sincere@april.biz\",\n    \"address\": {\n      \"street\": \"Kulas Light\",\n      \"suite\": \"Apt. 556\",\n      \"city\": \"Gwenborough\",\n      \"zipcode\": \"92998-3874\",\n      \"geo\": {\n        \"lat\": \"-37.3159\",\n        \"lng\": \"81.1496\"\n      }\n    },\n    \"phone\": \"1-770-736-8031 x56442\",\n    \"website\": \"hildegard.org\",\n    \"company\": {\n      \"name\": \"Romaguera-Crona\",\n      \"catchPhrase\": \"Multi-layered client-server neural-net\",\n      \"bs\": \"harness real-time e-markets\"\n    }\n  },\n  {\n    \"id\": 2,\n    \"name\": \"Ervin Howell\",\n    \"username\": \"Antonette\",\n    \"email\": \"Shanna@melissa.tv\",\n    \"address\": {\n      \"street\": \"Victor Plains\",\n      \"suite\": \"Suite 879\",\n      \"city\": \"Wisokyburgh\",\n      \"zipcode\": \"90566-7771\",\n      \"geo\": {\n        \"lat\": \"-43.9509\",\n        \"lng\": \"-34.4618\"\n      }\n    },\n    \"phone\": \"010-692-6593 x09125\",\n    \"website\": \"anastasia.net\",\n    \"company\": {\n      \"name\": \"Deckow-Crist\",\n      \"catchPhrase\": \"Proactive didactic contingency\",\n      \"bs\": \"synergize scalable supply-chains\"\n    }\n  },\n  {\n    \"id\": 3,\n    \"name\": \"Clementine Bauch\",\n    \"username\": \"Samantha\",\n    \"email\": \"Nathan@yesenia.net\",\n    \"address\": {\n      \"street\": \"Douglas Extension\",\n      \"suite\": \"Suite 847\",\n      \"city\": \"McKenziehaven\",\n      \"zipcode\": \"59590-4157\",\n      \"geo\": {\n        \"lat\": \"-68.6102\",\n        \"lng\": \"-47.0653\"\n      }\n    },\n    \"phone\": \"1-463-123-4447\",\n    \"website\": \"ramiro.info\",\n    \"company\": {\n      \"name\": \"Romaguera-Jacobson\",\n      \"catchPhrase\": \"Face to face bifurcated interface\",\n      \"bs\": \"e-enable strategic applications\"\n    }\n  },\n  {\n    \"id\": 4,\n    \"name\": \"Patricia Lebsack\",\n    \"username\": \"Karianne\",\n    \"email\": \"Julianne.OConner@kory.org\",\n    \"address\": {\n      \"street\": \"Hoeger Mall\",\n      \"suite\": \"Apt. 692\",\n      \"city\": \"South Elvis\",\n      \"zipcode\": \"53919-4257\",\n      \"geo\": {\n        \"lat\": \"29.4572\",\n        \"lng\": \"-164.2990\"\n      }\n    },\n    \"phone\": \"493-170-9623 x156\",\n    \"website\": \"kale.biz\",\n    \"company\": {\n      \"name\": \"Robel-Corkery\",\n      \"catchPhrase\": \"Multi-tiered zero tolerance productivity\",\n      \"bs\": \"transition cutting-edge web services\"\n    }\n  },\n  {\n    \"id\": 5,\n    \"name\": \"Chelsey Dietrich\",\n    \"username\": \"Kamren\",\n    \"email\": \"Lucio_Hettinger@annie.ca\",\n    \"address\": {\n      \"street\": \"Skiles Walks\",\n      \"suite\": \"Suite 351\",\n      \"city\": \"Roscoeview\",\n      \"zipcode\": \"33263\",\n      \"geo\": {\n        \"lat\": \"-31.8129\",\n        \"lng\": \"62.5342\"\n      }\n    },\n    \"phone\": \"(254)954-1289\",\n    \"website\": \"demarco.info\",\n    \"company\": {\n      \"name\": \"Keebler LLC\",\n      \"catchPhrase\": \"User-centric fault-tolerant solution\",\n      \"bs\": \"revolutionize end-to-end systems\"\n    }\n  },\n  {\n    \"id\": 6,\n    \"name\": \"Mrs. Dennis Schulist\",\n    \"username\": \"Leopoldo_Corkery\",\n    \"email\": \"Karley_Dach@jasper.info\",\n    \"address\": {\n      \"street\": \"Norberto Crossing\",\n      \"suite\": \"Apt. 950\",\n      \"city\": \"South Christy\",\n      \"zipcode\": \"23505-1337\",\n      \"geo\": {\n        \"lat\": \"-71.4197\",\n        \"lng\": \"71.7478\"\n      }\n    },\n    \"phone\": \"1-477-935-8478 x6430\",\n    \"website\": \"ola.org\",\n    \"company\": {\n      \"name\": \"Considine-Lockman\",\n      \"catchPhrase\": \"Synchronised bottom-line interface\",\n      \"bs\": \"e-enable innovative applications\"\n    }\n  },\n  {\n    \"id\": 7,\n    \"name\": \"Kurtis Weissnat\",\n    \"username\": \"Elwyn.Skiles\",\n    \"email\": \"Telly.Hoeger@billy.biz\",\n    \"address\": {\n      \"street\": \"Rex Trail\",\n      \"suite\": \"Suite 280\",\n      \"city\": \"Howemouth\",\n      \"zipcode\": \"58804-1099\",\n      \"geo\": {\n        \"lat\": \"24.8918\",\n        \"lng\": \"21.8984\"\n      }\n    },\n    \"phone\": \"210.067.6132\",\n    \"website\": \"elvis.io\",\n    \"company\": {\n      \"name\": \"Johns Group\",\n      \"catchPhrase\": \"Configurable multimedia task-force\",\n      \"bs\": \"generate enterprise e-tailers\"\n    }\n  },\n  {\n    \"id\": 8,\n    \"name\": \"Nicholas Runolfsdottir V\",\n    \"username\": \"Maxime_Nienow\",\n    \"email\": \"Sherwood@rosamond.me\",\n    \"address\": {\n      \"street\": \"Ellsworth Summit\",\n      \"suite\": \"Suite 729\",\n      \"city\": \"Aliyaview\",\n      \"zipcode\": \"45169\",\n      \"geo\": {\n        \"lat\": \"-14.3990\",\n        \"lng\": \"-120.7677\"\n      }\n    },\n    \"phone\": \"586.493.6943 x140\",\n    \"website\": \"jacynthe.com\",\n    \"company\": {\n      \"name\": \"Abernathy Group\",\n      \"catchPhrase\": \"Implemented secondary concept\",\n      \"bs\": \"e-enable extensible e-tailers\"\n    }\n  },\n  {\n    \"id\": 9,\n    \"name\": \"Glenna Reichert\",\n    \"username\": \"Delphine\",\n    \"email\": \"Chaim_McDermott@dana.io\",\n    \"address\": {\n      \"street\": \"Dayna Park\",\n      \"suite\": \"Suite 449\",\n      \"city\": \"Bartholomebury\",\n      \"zipcode\": \"76495-3109\",\n      \"geo\": {\n        \"lat\": \"24.6463\",\n        \"lng\": \"-168.8889\"\n      }\n    },\n    \"phone\": \"(775)976-6794 x41206\",\n    \"website\": \"conrad.com\",\n    \"company\": {\n      \"name\": \"Yost and Sons\",\n      \"catchPhrase\": \"Switchable contextually-based project\",\n      \"bs\": \"aggregate real-time technologies\"\n    }\n  },\n  {\n    \"id\": 10,\n    \"name\": \"Clementina DuBuque\",\n    \"username\": \"Moriah.Stanton\",\n    \"email\": \"Rey.Padberg@karina.biz\",\n    \"address\": {\n      \"street\": \"Kattie Turnpike\",\n      \"suite\": \"Suite 198\",\n      \"city\": \"Lebsackbury\",\n      \"zipcode\": \"31428-2261\",\n      \"geo\": {\n        \"lat\": \"-38.2386\",\n        \"lng\": \"57.2232\"\n      }\n    },\n    \"phone\": \"024-648-3804\",\n    \"website\": \"ambrose.net\",\n    \"company\": {\n      \"name\": \"Hoeger LLC\",\n      \"catchPhrase\": \"Centralized empowering task-force\",\n      \"bs\": \"target end-to-end models\"\n    }\n  }\n]","Name":"staticdata","DefinitionName":"eg_WorldMap_staticdata","Source":"https://jsonplaceholder.typicode.com/users","data":[{"id":1,"name":"Leanne Graham","username":"Bret","email":"Sincere@april.biz","address":{"street":"Kulas Light","suite":"Apt. 556","city":"Gwenborough","zipcode":"92998-3874","geo":{"lat":"-37.3159","lng":"81.1496"}},"phone":"1-770-736-8031 x56442","website":"hildegard.org","company":{"name":"Romaguera-Crona","catchPhrase":"Multi-layered client-server neural-net","bs":"harness real-time e-markets"}},{"id":2,"name":"Ervin Howell","username":"Antonette","email":"Shanna@melissa.tv","address":{"street":"Victor Plains","suite":"Suite 879","city":"Wisokyburgh","zipcode":"90566-7771","geo":{"lat":"-43.9509","lng":"-34.4618"}},"phone":"010-692-6593 x09125","website":"anastasia.net","company":{"name":"Deckow-Crist","catchPhrase":"Proactive didactic contingency","bs":"synergize scalable supply-chains"}},{"id":3,"name":"Clementine Bauch","username":"Samantha","email":"Nathan@yesenia.net","address":{"street":"Douglas Extension","suite":"Suite 847","city":"McKenziehaven","zipcode":"59590-4157","geo":{"lat":"-68.6102","lng":"-47.0653"}},"phone":"1-463-123-4447","website":"ramiro.info","company":{"name":"Romaguera-Jacobson","catchPhrase":"Face to face bifurcated interface","bs":"e-enable strategic applications"}},{"id":4,"name":"Patricia Lebsack","username":"Karianne","email":"Julianne.OConner@kory.org","address":{"street":"Hoeger Mall","suite":"Apt. 692","city":"South Elvis","zipcode":"53919-4257","geo":{"lat":"29.4572","lng":"-164.2990"}},"phone":"493-170-9623 x156","website":"kale.biz","company":{"name":"Robel-Corkery","catchPhrase":"Multi-tiered zero tolerance productivity","bs":"transition cutting-edge web services"}},{"id":5,"name":"Chelsey Dietrich","username":"Kamren","email":"Lucio_Hettinger@annie.ca","address":{"street":"Skiles Walks","suite":"Suite 351","city":"Roscoeview","zipcode":"33263","geo":{"lat":"-31.8129","lng":"62.5342"}},"phone":"(254)954-1289","website":"demarco.info","company":{"name":"Keebler LLC","catchPhrase":"User-centric fault-tolerant solution","bs":"revolutionize end-to-end systems"}},{"id":6,"name":"Mrs. Dennis Schulist","username":"Leopoldo_Corkery","email":"Karley_Dach@jasper.info","address":{"street":"Norberto Crossing","suite":"Apt. 950","city":"South Christy","zipcode":"23505-1337","geo":{"lat":"-71.4197","lng":"71.7478"}},"phone":"1-477-935-8478 x6430","website":"ola.org","company":{"name":"Considine-Lockman","catchPhrase":"Synchronised bottom-line interface","bs":"e-enable innovative applications"}},{"id":7,"name":"Kurtis Weissnat","username":"Elwyn.Skiles","email":"Telly.Hoeger@billy.biz","address":{"street":"Rex Trail","suite":"Suite 280","city":"Howemouth","zipcode":"58804-1099","geo":{"lat":"24.8918","lng":"21.8984"}},"phone":"210.067.6132","website":"elvis.io","company":{"name":"Johns Group","catchPhrase":"Configurable multimedia task-force","bs":"generate enterprise e-tailers"}},{"id":8,"name":"Nicholas Runolfsdottir V","username":"Maxime_Nienow","email":"Sherwood@rosamond.me","address":{"street":"Ellsworth Summit","suite":"Suite 729","city":"Aliyaview","zipcode":"45169","geo":{"lat":"-14.3990","lng":"-120.7677"}},"phone":"586.493.6943 x140","website":"jacynthe.com","company":{"name":"Abernathy Group","catchPhrase":"Implemented secondary concept","bs":"e-enable extensible e-tailers"}},{"id":9,"name":"Glenna Reichert","username":"Delphine","email":"Chaim_McDermott@dana.io","address":{"street":"Dayna Park","suite":"Suite 449","city":"Bartholomebury","zipcode":"76495-3109","geo":{"lat":"24.6463","lng":"-168.8889"}},"phone":"(775)976-6794 x41206","website":"conrad.com","company":{"name":"Yost and Sons","catchPhrase":"Switchable contextually-based project","bs":"aggregate real-time technologies"}},{"id":10,"name":"Clementina DuBuque","username":"Moriah.Stanton","email":"Rey.Padberg@karina.biz","address":{"street":"Kattie Turnpike","suite":"Suite 198","city":"Lebsackbury","zipcode":"31428-2261","geo":{"lat":"-38.2386","lng":"57.2232"}},"phone":"024-648-3804","website":"ambrose.net","company":{"name":"Hoeger LLC","catchPhrase":"Centralized empowering task-force","bs":"target end-to-end models"}}]}, 
...
eg_Memory_state: {"Parent":"eg_Memory","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","message":"Good luck!","win":false,"cards":[],"revealed":[],"lastflipped":null,"failedflip":null,"Name":"state","DefinitionName":"eg_Memory_state"}, 

eg_Memory_script: {"Parent":"eg_Memory","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"eg_Memory_script","Directives":[]}, 
...
eg_ConwayGameOfLife_template: {"Parent":"eg_ConwayGameOfLife","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"eg_ConwayGameOfLife_template","Hash":"Tx1spom4d"}, 

eg_ConwayGameOfLife_state: {"Parent":"eg_ConwayGameOfLife","DefName":null,"Type":"State","Directives":["bindMount","bindUnmount"],"Store":null,"Content":"","playing":false,"speed":3,"cells":{"10":{"11":true},"11":{"12":true},"12":{"10":true,"11":true,"12":true}},"Name":"state","DefinitionName":"eg_ConwayGameOfLife_state"}, 

eg_ConwayGameOfLife_script: {"Parent":"eg_ConwayGameOfLife","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|ScriptAutoExport","Code"],"Name":"script","DefinitionName":"eg_ConwayGameOfLife_script","Directives":[]}, 
