...
currentModulo.assets.functions["nmpst5"]= function (CTX, G){
var OUT=[];
...
currentModulo.assets.functions["75l0c5"]= function (CTX, G){
var OUT=[];
  OUT.push("\n    "); // ""
...
currentModulo.assets.functions["a7qcs5"]= function (CTX, G){
var OUT=[];
...
currentModulo.assets.functions["x1as5m87"]= function (CTX, G){
var OUT=[];
  OUT.push("\n    "); // ""
  var ARR0=CTX.staticdata;for (var KEY in ARR0) {CTX. user=ARR0[KEY]; // "for user in staticdata"
...
currentModulo.assets.functions["1mtk3os"]= function (){
return [
  {
    "id": 1,
    "name": "Leanne Graham",
...
modulo.assets.functions['xqf9b9l']('x-demomodal');

modulo.assets.functions['sg83u6']('x-demochart');

modulo.assets.functions['x1da3243']('x-examplebtn');

modulo.assets.functions['x33s3q']('x-demoselector');

modulo.assets.functions['433vtt']('mws-page');

modulo.assets.functions['x1i275kj']('mws-projectinfo');

modulo.assets.functions['x1aqc8h6']('mws-devlognav');

modulo.assets.functions['x1juvmkg']('mws-docsidebar');

modulo.assets.functions['x6nt2r0']('mws-demo');

modulo.assets.functions['xtg6cqb']('mws-allexamples');

modulo.assets.functions['l1gr4i']('mws-section');

modulo.assets.functions['17sct8m']('docseg-templating_1');

modulo.assets.functions['1mvqm2k']('docseg-templating_preparecallback');

modulo.assets.functions['x4kk41c']('docseg-templating_comments');

modulo.assets.functions['x14uqs09']('docseg-templating_escaping');

modulo.assets.functions['xif6qno']('docseg-tutorial_p1');

modulo.assets.functions['x1c4jlk3']('docseg-tutorial_p2');

modulo.assets.functions['x1gqlqhr']('docseg-tutorial_p2_filters_demo');

modulo.assets.functions['xpmn7oi']('docseg-tutorial_p3_state_demo');

modulo.assets.functions['1sc0e93']('docseg-tutorial_p3_state_bind');

modulo.assets.functions['14n8egj']('eg-hello');

modulo.assets.functions['r5jke9']('eg-simple');

modulo.assets.functions['18e8a6j']('eg-todo');

modulo.assets.functions['cf1msk']('eg-json');

modulo.assets.functions['x2b520g']('eg-jsonarray');

modulo.assets.functions['cd55r1']('eg-githubapi');

modulo.assets.functions['x1ii4dc3']('eg-colorselector');

modulo.assets.functions['f4cpaa']('eg-datenumberpicker');

modulo.assets.functions['x1g4uuhi']('eg-primesieve');

modulo.assets.functions['1vfteg8']('eg-scatter');

modulo.assets.functions['1ns7ff4']('eg-flexibleform');

modulo.assets.functions['x1m1b3bs']('eg-flexibleformwithapi');

modulo.assets.functions['8bv8j2']('eg-components');

modulo.assets.functions['x7jhpv4']('eg-oscillatinggraph');

modulo.assets.functions['xlrsjv0']('eg-search');

modulo.assets.functions['x1jlcjv6']('eg-searchbox');

modulo.assets.functions['x14gac81']('eg-worldmap');

modulo.assets.functions['4ita9']('eg-memory');

modulo.assets.functions['xao68n1']('eg-conwaygameoflife');
