...
window.moduloBuild.modules["xxepa8pn"] = function JSON_staticdata (modulo) {
...
window.moduloBuild.modules["xx15kru4"] = function configuration (modulo) {
    ...
    function getComponentDefs(path) {
        ...
        if (confDef.cachedComponentDefs) {
            ...
            if (!(path in confDef.cachedComponentDefs)) {
                console.log('cachedComponentDefs - not found inititially', path);
                for (const realPath of Object.keys(confDef.cachedComponentDefs).sort()) {
                    console.log('realPath-', realPath, realPath.endsWith(path));
...
window.moduloBuild.definitions = {
 "configuration": {
  ...
  "cachedComponentDefs": {
   ...
   "http://127.0.0.1:6627/libraries/docseg.html": {
 ...
 "JSON_staticdata": {
  ...
  "Content": "{\"message\":\"API rate limit exceeded for 23.93.67.213. (But here's the good news: Authenticated requests get a higher rate limit. Check out the documentation for more details.)\",\"documentation_url\":\"https://docs.github.com/rest/overview/resources-in-the-rest-api#rate-limiting\"}\n",
  "DefName": null,
  "Parent": "JSON",
  "Name": "staticdata",
  ...
  "data": {
   "message": "API rate limit exceeded for 23.93.67.213. (But here's the good news: Authenticated requests get a higher rate limit. Check out the documentation for more details.)",
