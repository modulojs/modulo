...
window.moduloBuild.modules["x1nb0621"] = function eg_JSON_staticdata (modulo) {
...
window.moduloBuild.nameToHash.eg_JSON_staticdata = "x1nb0621";
    ...
    repeatProcessors(defs, field, cb) {
        ...
        while (changed) {
            ...
            for (const def of (defs || Object.values(this.definitions))) {
                ...
                if (def.DefinitionName === 'Page_template') {
                    console.log('processors ARE', def.DefinitionName, def);
                }
